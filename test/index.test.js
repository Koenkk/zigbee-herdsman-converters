...
describe('index.js', () => {
    ...
    it('Verify devices.js definitions', () => {
        ...
        devices.forEach((device) => {
            ...
            if (device.meta) {
                containsOnly(['disableActionGroup', 'configureKey', 'multiEndpoint', 'applyRedFix', 'disableDefaultResponse', 'enhancedHue', 'timeout', 'supportsHueAndSaturation', 'battery', 'coverInverted', 'turnsOffAtBrightness1', 'pinCodeCount', 'tuyaThermostatSystemMode', 'tuyaThermostatPreset', 'commandArmIncludeTransaction', 'weeklyScheduleMaxTransitions', 'weeklyScheduleSupportedModes', 'weeklyScheduleFirstDayDpId'], Object.keys(device.meta));
            }
