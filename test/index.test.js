...
describe('index.js', () => {
    ...
    it('Verify definitions', () => {
        ...
        index.definitions.forEach((device) => {
            ...
            if (device.meta) {
                containsOnly(['handleDuplicateTransaction', 'disableActionGroup', 'multiEndpoint', 'applyRedFix', 'disableDefaultResponse', 'enhancedHue', 'timeout', 'supportsHueAndSaturation', 'battery', 'coverInverted', 'turnsOffAtBrightness1', 'pinCodeCount', 'tuyaThermostatSystemMode', 'tuyaThermostatPreset', 'tuyaThermostatPresetToSystemMode', 'thermostat', 'fanStateOn', 'separateWhite'], Object.keys(device.meta));
            }
