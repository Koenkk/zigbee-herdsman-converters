...
describe('lib/xiaomiTrvUtils', () => {
    describe(xiaomiTrvUtils.decodeTrvPreset, () => {
        it('decodes setup mode', () => {
            const preset = xiaomiTrvUtils.decodeTrvPreset(3);
        ...
        it('decodes user preset', () => {
            const preset = xiaomiTrvUtils.decodeTrvPreset(0);
    ...
    describe(xiaomiTrvUtils.decodeTrvHeartbeat, () => {
        ...
        it('decodes heartbeat in setup mode', () => {
            const heartbeat = xiaomiTrvUtils.decodeTrvHeartbeat({}, {}, heartbeatSetup);
        ...
        it('decodes heartbeat in normal operation', () => {
            const heartbeat = xiaomiTrvUtils.decodeTrvHeartbeat({}, {}, heartbeatNormalOperation);
        ...
        it('decodes valve alarm', () => {
            const heartbeat = xiaomiTrvUtils.decodeTrvHeartbeat({}, {}, heartbeatValveAlarm);
