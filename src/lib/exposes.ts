...
export const presets = {
    ...
    qnh: () => new Numeric('qnh', access.STATE).withLabel('QNH').withUnit('hPa').withDescription('Mean sea level pressure'),
    ...
    wind_speed_average: () => new Numeric('wind_speed_average', access.STATE).withLabel('Wind Speed').withDescription('Average wind speed'),
    wind_speed_gust: () => new Numeric('wind_speed_gust', access.STATE).withLabel('Wind Gust').withDescription('Wind gust'),
