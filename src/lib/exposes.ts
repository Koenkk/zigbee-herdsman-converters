...
export const presets = {
    ...
    temperature_sensor_select: (sensor_names: string[]) => new Enum('sensor', access.ALL, sensor_names).withDescription('Select temperature sensor to use').withCategory('config'),
