...
export const presets = {
    ...
    action_direction: (values: string[]) => new Enum('action_direction', access.STATE, values).withDescription('Direction in which the dial was turned'),
    action_time: () => new Numeric('action_time', access.STATE).withDescription('Raw value that represents the amount the dial was turned').withValueMin(0).withValueMax(255),
