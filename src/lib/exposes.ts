...
export const presets = {
    ...
    current_phase_a: () => new Numeric('current_phase_a', access.STATE).withUnit('A').withDescription('Instantaneous measured electrical current on phase A'),
    ...
    power_phase_a: () => new Numeric('power_phase_a', access.STATE).withUnit('W').withDescription('Instantaneous measured power on phase A'),
    ...
    voltage_phase_a: () => new Numeric('voltage_phase_a', access.STATE).withUnit('V').withDescription('Measured electrical potential value on phase A'),
