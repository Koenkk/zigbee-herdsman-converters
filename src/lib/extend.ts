...
import {Expose, Fz, Tz, Extend, ModernExtend} from './types';
...
const modernExtend = {
    enumLookup: (args: {
        ...
        const expose: Expose = new Enum(name, args.readOnly ? access.STATE_GET : access.ALL, Object.keys(lookup)).withDescription(description);
