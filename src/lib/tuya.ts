...
const tuyaExposes = {
    ...
    switchTypeCurtain: () => e.enum("switch_type_curtain", ea.ALL, ["flip-switch", "sync-switch", "button-switch","button2-switch"]).withDescription("what external switch have you applied?"),
...
export const valueConverter = {
    ...
    switchTypeCurtain: exports.valueConverterBasic.lookup({"flip-switch": new Enum(0), "sync-switch": new Enum(1), "button-switch": new Enum(2), "button2-switch":new Enum(3)}),
