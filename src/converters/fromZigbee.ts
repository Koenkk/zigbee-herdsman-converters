...
export const thermostat_weekly_schedule: Fz.Converter<"hvacThermostat"> = {
    cluster: "hvacThermostat",
...
export const lock_operation_event: Fz.Converter<"closuresDoorLock"> = {
...
export const lock_programming_event: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
...
export const lock_programming_event_read_pincode: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
    type: "commandProgrammingEventNotification",
    convert: (model, msg, publish, options, meta) => {
        if (
...
export const lock_set_pin_code_response: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
...
export const lock_pin_code_response: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
...
export const lock_user_status_response: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
...
export const ias_no_alarm: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
...
export const ias_siren: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
...
export const ias_water_leak_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_vibration_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_vibration_alarm_1_with_timeout: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
...
export const ias_gas_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_gas_alarm_2: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_smoke_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
...
export const ias_contact_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_carbon_monoxide_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_carbon_monoxide_alarm_1_gas_alarm_2: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
...
export const ias_sos_alarm_2: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_occupancy_alarm_1: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_occupancy_alarm_2: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_occupancy_only_alarm_2: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ias_occupancy_alarm_1_with_timeout: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
...
export const command_store: Fz.Converter<"genScenes"> = {
    cluster: "genScenes",
    type: "commandStore",
    convert: (model, msg, publish, options, meta) => {
...
export const command_recall: Fz.Converter<"genScenes"> = {
    cluster: "genScenes",
    type: "commandRecall",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_panic: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
    type: "commandPanic",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_arm: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
    type: "commandArm",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_cover_stop: Fz.Converter<"closuresWindowCovering"> = {
...
export const command_cover_open: Fz.Converter<"closuresWindowCovering"> = {
    cluster: "closuresWindowCovering",
    type: "commandUpOpen",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_cover_close: Fz.Converter<"closuresWindowCovering"> = {
    cluster: "closuresWindowCovering",
...
export const command_on: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOn",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_off: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOff",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_off_with_effect: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
...
export const command_toggle: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandToggle",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_move_to_level: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
...
export const command_move: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
...
export const command_step: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
...
export const command_stop: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
...
export const command_move_color_temperature: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_step_color_temperature: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_enhanced_move_to_hue_and_saturation: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_move_to_hue_and_saturation: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_step_hue: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: ["commandStepHue"],
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_step_saturation: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_color_loop_set: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_move_to_color_temp: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_move_to_color: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_move_hue: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: "commandMoveHue",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_move_to_saturation: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_move_to_hue: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const command_emergency: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
...
export const command_on_state: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOn",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const command_off_state: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOff",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const checkin_presence: Fz.Converter<"genPollCtrl"> = {
    cluster: "genPollCtrl",
    type: ["commandCheckin"],
...
export const namron_thermostat: Fz.Converter<"hvacThermostat"> = {
    cluster: "hvacThermostat",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
export const ias_smoke_alarm_1_develco: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const ts0201_temperature_humidity_alarm: Fz.Converter<"manuSpecificTuya2"> = {
...
export const tuya_doorbell_button: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const DTB190502A1: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const ZigUP: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const lookup: KeyValueAny = {
...
export const WSZ01_on_off_action: Fz.Converter<65029> = {
    cluster: 65029,
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
...
export const tuya_switch_scene: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
...
export const livolo_socket_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const livolo_new_switch_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const livolo_new_switch_state_2gang: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const livolo_new_switch_state_4gang: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const livolo_curtain_switch_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const livolo_dimmer_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const livolo_cover_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const livolo_hygrometer_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const dp = msg.data[10];
...
export const livolo_illuminance_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const livolo_pir_state: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const stateHeader = Buffer.from([122, 209]);
...
export const easycode_action: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
        const lookup: KeyValueAny = {
...
export const easycodetouch_action: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
...
export const livolo_switch_state_raw: Fz.Converter<"genPowerCfg"> = {
    cluster: "genPowerCfg",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        /*
...
export const heiman_ir_remote: Fz.Converter<"heimanSpecificInfraRedRemote"> = {
...
export const orvibo_raw_1: Fz.Converter<23> = {
    cluster: 23,
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
...
export const orvibo_raw_2: Fz.Converter<23> = {
    cluster: 23,
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
        const buttonLookup: KeyValueAny = {
...
export const tint_scene: Fz.Converter<"genBasic"> = {
    cluster: "genBasic",
    type: "write",
    convert: (model, msg, publish, options, meta) => {
...
export const tint404011_move_to_color_temp: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: "commandMoveToColorTemp",
    convert: (model, msg, publish, options, meta) => {
...
export const ewelink_action: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
...
export const diyruz_rspm: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const enocean_ptm215z: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
...
export const enocean_ptm215ze: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
export const enocean_ptm216z: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const _8840100H_water_leak_alarm: Fz.Converter<"haApplianceEventsAlerts"> = {
...
export const byun_smoke_true: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: ["commandStatusChangeNotification"],
    convert: (model, msg, publish, options, meta) => {
...
export const byun_gas_false: Fz.Converter<1034> = {
    cluster: 1034,
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const byun_gas_true: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: ["commandStatusChangeNotification"],
    convert: (model, msg, publish, options, meta) => {
        if (msg.endpoint.ID === 1 && msg.data.zonestatus === 33) {
...
export const hue_smart_button_event: Fz.Converter<"manuSpecificPhilips"> = {
...
export const legrand_scenes: Fz.Converter<"genScenes"> = {
    cluster: "genScenes",
    type: "commandRecall",
    convert: (model, msg, publish, options, meta) => {
...
export const legrand_master_switch_center: Fz.Converter<"manuSpecificLegrandDevices"> = {
...
export const legrand_power_alarm: Fz.Converter<"haElectricalMeasurement"> = {
    cluster: "haElectricalMeasurement",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const payload: KeyValueAny = {};
...
export const legrand_greenpower: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const W2_module_carbon_monoxide: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const command_status_change_notification_action: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const U02I007C01_contact: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const U02I007C01_water_leak: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const scenes_recall_scene_65024: Fz.Converter<65024> = {
    cluster: 65024,
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const adeo_button_65024: Fz.Converter<65024> = {
    cluster: 65024,
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const color_stop_raw: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
export const almond_click: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
    type: ["commandArm"],
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const SAGE206612_state: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const PGC410EU_presence: Fz.Converter<"manuSpecificSmartThingsArrivalSensor"> = {
...
export const heiman_scenes: Fz.Converter<"heimanSpecificScenes"> = {
...
export const javis_lock_report: Fz.Converter<"genBasic"> = {
    cluster: "genBasic",
    type: "attributeReport",
    convert: (model, msg, publish, options, meta) => {
        const lookup: KeyValueAny = {
...
export const diyruz_geiger: Fz.Converter<"msIlluminanceMeasurement"> = {
...
export const diyruz_geiger_config: Fz.Converter<"msIlluminanceLevelSensing"> = {
...
export const diyruz_airsense_config_co2: Fz.Converter<"msCO2"> = {
    cluster: "msCO2",
    type: "readResponse",
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
export const diyruz_airsense_config_temp: Fz.Converter<"msTemperatureMeasurement"> = {
    cluster: "msTemperatureMeasurement",
    type: "readResponse",
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
export const diyruz_airsense_config_pres: Fz.Converter<"msPressureMeasurement"> = {
    cluster: "msPressureMeasurement",
    type: "readResponse",
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
export const diyruz_airsense_config_hum: Fz.Converter<"msRelativeHumidity"> = {
    cluster: "msRelativeHumidity",
    type: "readResponse",
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
export const diyruz_zintercom_config: Fz.Converter<"closuresDoorLock"> = {
    cluster: "closuresDoorLock",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValueAny = {};
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const KAMI_contact: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const KAMI_occupancy: Fz.Converter<"msOccupancySensing"> = {
    cluster: "msOccupancySensing",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        if (msg.data[7] === 1) {
...
export const hue_motion_sensitivity: Fz.Converter<"msOccupancySensing"> = {
    cluster: "msOccupancySensing",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const hue_motion_led_indication: Fz.Converter<"genBasic"> = {
    cluster: "genBasic",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const hue_wall_switch_device_mode: Fz.Converter<"genBasic"> = {
    cluster: "genBasic",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const CCTSwitch_D0001_levelctrl: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const CCTSwitch_D0001_lighting: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
...
export const hue_wall_switch: Fz.Converter<"manuSpecificPhilips"> = {
    cluster: "manuSpecificPhilips",
    type: "commandHueNotification",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const hue_dimmer_switch: Fz.Converter<"manuSpecificPhilips"> = {
    cluster: "manuSpecificPhilips",
    type: "commandHueNotification",
    options: [exposes.options.simulated_brightness()],
    convert: (model, msg, publish, options, meta) => {
...
export const hue_tap: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
export const hue_twilight: Fz.Converter<"manuSpecificPhilips"> = {
    cluster: "manuSpecificPhilips",
    type: "commandHueNotification",
    convert: (model, msg, publish, options, meta) => {
...
export const tuya_relay_din_led_indicator: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const ias_keypad: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const ZB003X_occupancy: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        const zoneStatus = msg.data.zonestatus;
...
export const wiser_smart_thermostat_client: Fz.Converter<"hvacThermostat"> = {
    cluster: "hvacThermostat",
    type: "read",
...
export const wiser_smart_setpoint_command_client: Fz.Converter<"hvacThermostat"> = {
    cluster: "hvacThermostat",
    // TODO: "command"!?
...
export const rc_110_level_to_scene: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: ["commandMoveToLevel", "commandMoveToLevelWithOnOff"],
    convert: (model, msg, publish, options, meta) => {
...
export const heiman_doorbell_button: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {
        if (hasAlreadyProcessedMessage(msg, model)) return;
...
export const sihas_action: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: ["commandOn", "commandOff", "commandToggle"],
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const sunricher_switch2801K2: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const sunricher_switch2801K4: Fz.Converter<"greenPower"> = {
    cluster: "greenPower",
    type: ["commandNotification", "commandCommissioningNotification"],
    convert: (model, msg, publish, options, meta) => {
        const commandID = msg.data.commandID;
...
export const command_stop_move_raw: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
...
export const tuya_multi_action: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
...
export const awox_colors: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const awox_refreshColored: Fz.Converter<"lightingColorCtrl"> = {
    cluster: "lightingColorCtrl",
    type: ["commandMoveHue"],
    convert: (model, msg, publish, options, meta) => {
...
export const awox_refresh: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {
        const buffer = msg.data;
...
export const ignore_iaszone_statuschange: Fz.Converter<"ssIasZone"> = {
    cluster: "ssIasZone",
    type: "commandStatusChangeNotification",
    convert: (model, msg, publish, options, meta) => {},
};
...
export const ignore_command_on: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOn",
    convert: (model, msg, publish, options, meta) => {},
};
export const ignore_command_off: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOff",
    convert: (model, msg, publish, options, meta) => {},
};
export const ignore_command_off_with_effect: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOffWithEffect",
    convert: (model, msg, publish, options, meta) => {},
};
export const ignore_command_step: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: "commandStep",
    convert: (model, msg, publish, options, meta) => {},
};
export const ignore_command_stop: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: "commandStop",
    convert: (model, msg, publish, options, meta) => {},
};
...
export const ignore_tuya_set_time: Fz.Converter<"manuSpecificTuya"> = {
    cluster: "manuSpecificTuya",
    type: ["commandMcuSyncTime"],
    convert: (model, msg, publish, options, meta) => {},
};
export const ignore_tuya_raw: Fz.Converter<"manuSpecificTuya"> = {
    cluster: "manuSpecificTuya",
    type: ["raw"],
    convert: (model, msg, publish, options, meta) => {},
};
...
export const command_arm_with_transaction: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
    type: "commandArm",
    convert: (model, msg, publish, options, meta) => {
...
export const command_on_presence: Fz.Converter<"genOnOff"> = {
    cluster: "genOnOff",
    type: "commandOn",
    convert: (model, msg, publish, options, meta) => {
...
export const ias_ace_occupancy_with_timeout: Fz.Converter<"ssIasAce"> = {
    cluster: "ssIasAce",
    type: "commandGetPanelStatus",
    options: [exposes.options.occupancy_timeout()],
    convert: (model, msg, publish, options, meta) => {
...
export const terncy_raw: Fz.Converter<"manuSpecificClusterAduroSmart"> = {
    cluster: "manuSpecificClusterAduroSmart",
    type: "raw",
    convert: (model, msg, publish, options, meta) => {
...
export const schneider_lighting_ballast_configuration: Fz.Converter<"lightingBallastCfg"> = {
    cluster: "lightingBallastCfg",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
...
export const TS110E: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValue = {};
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const TS110E_light_type: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValue = {};
...
// biome-ignore lint/style/useNamingConvention: ignored using `--suppress`
export const TS110E_switch_type: Fz.Converter<"genLevelCtrl"> = {
    cluster: "genLevelCtrl",
    type: ["attributeReport", "readResponse"],
    convert: (model, msg, publish, options, meta) => {
        const result: KeyValue = {};
