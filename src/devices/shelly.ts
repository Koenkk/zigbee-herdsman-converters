        ...
        const fromZigbee: Fz.Converter<any, any, any>[] = [
            ...
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (data[0x0000] !== undefined) {
                        const uv_index = (data[0x0000] as number) / 10;
            ...
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (data[0x0000] !== undefined) payload.wind_speed = (data[0x0000] as number) / 10;
                    if (data[0x0004] !== undefined) payload.wind_direction = (data[0x0004] as number) / 10;
                    if (data[0x0007] !== undefined) payload.gust_speed = (data[0x0007] as number) / 10;
            ...
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (data[0x0000] !== undefined) payload.rain_status = Boolean(data[0x0000]);
                    if (data[0x0001] !== undefined) {
                        payload.precipitation = (data[0x0001] as number) / 10;
                    }
