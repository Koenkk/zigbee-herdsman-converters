...
export const definitions: DefinitionWithExtend[] = [
    {
        fingerprint: tuya.fingerprint("TS0601", ["_TZE200_akjefhj5", "_TZE200_2wg5qrjy", "_TZE200_81isopgh", "_TZE284_xuflgcnz", "_TZE284_qtnjuoae", "_TZE204_qtnjuoae"]),
        model: "ZVG1",
        vendor: "RTX",
        ...
        exposes: [
            ...
            e
                ...
                .withDescription(
                    "Format 08:00 / 20:00 / 15 / 60 / MoTuWeThFrSaSu / 1 (" +
                        "08:00 = start time " +
                        "20:00 = end time " +
            ...
            e
                ...
                .withDescription(
                    "Format 08:00 / 15 / MoTuWeThFrSaSu / 1 (" +
                        "08:00 = start time " +
