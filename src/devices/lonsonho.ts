...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        vendor: 'Lonsonho',
        description: '2CH Zigbee 0-10V Dimmer Module',
        ...
        meta: {
            ...
            tuyaDatapoints: [
                ...
                [4, 'switch_type_l1', tuya.valueConverterBasic.lookup({
                    'momentary': new tuya.Enum(0),
                    'toggle': new tuya.Enum(1),
                    'state': new tuya.Enum(2),
                })],
                ...
                [10, 'switch_type_l2', tuya.valueConverterBasic.lookup({
                    'momentary': new tuya.Enum(0),
                    'toggle': new tuya.Enum(1),
                    'state': new tuya.Enum(2),
                })],
