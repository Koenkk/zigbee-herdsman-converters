...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        extend: [m.deviceEndpoints({"endpoints":{"1":1,"2":2,"3":3,"4":4,"21":21}}), m.windowCovering({"controls":["lift","tilt"]}), m.electricityMeter(), m.numeric({"name":"analog_input_21","cluster":"genAnalogInput","attribute":"presentValue","reporting":{"min":"MIN","max":"MAX","change":1},"description":"analog_input_21","access":"STATE_GET","endpointNames":["21"]})],
        meta: {"multiEndpoint":true},
    },
    {
