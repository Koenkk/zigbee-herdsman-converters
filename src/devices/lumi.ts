...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_WXKG01LM_action, lumi.legacyFromZigbee.lumi_click],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_WXKG11LM_action, lumi.fromZigbee.lumi_basic,
            lumi.legacyFromZigbee.lumi_click, lumi.legacyFromZigbee.lumi_click_multistate],
        toZigbee: [],
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_action_multistate, lumi.legacyFromZigbee.lumi_click_multistate],
        toZigbee: [],
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action, lumi.fromZigbee.lumi_basic, lumi.legacyFromZigbee.lumi_click],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_on_off_ignore_endpoint_4_5_6, lumi.fromZigbee.lumi_action,
            lumi.legacyFromZigbee.lumi_click, lumi.fromZigbee.lumi_operation_mode_basic],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action, lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_on_off_ignore_endpoint_4_5_6,
            lumi.legacyFromZigbee.lumi_click, lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_operation_mode_basic,
            lumi.legacyFromZigbee.lumi_click_multistate, fz.ignore_multistate_report, lumi.fromZigbee.lumi_power],
        exposes: [
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action, lumi.fromZigbee.lumi_on_off_ignore_endpoint_4_5_6,
            lumi.legacyFromZigbee.lumi_click, lumi.legacyFromZigbee.lumi_buttons,
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_action, lumi.fromZigbee.lumi_action_multistate, lumi.fromZigbee.lumi_on_off_ignore_endpoint_4_5_6,
            lumi.legacyFromZigbee.lumi_click, lumi.fromZigbee.lumi_basic,
            lumi.fromZigbee.lumi_operation_mode_basic, lumi.legacyFromZigbee.lumi_click_multistate, lumi.fromZigbee.lumi_power],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.legacyFromZigbee.lumi_action, lumi.legacyFromZigbee.lumi_action_multistate],
        toZigbee: [],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_on_off_ignore_endpoint_4_5_6, lumi.fromZigbee.lumi_action,
            lumi.legacyFromZigbee.lumi_click,
            lumi.legacyFromZigbee.lumi_buttons, lumi.fromZigbee.lumi_operation_mode_basic],
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
            e.action(['release_left', 'release_right', 'release_both', 'double_left', 'double_right',
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, fz.occupancy_with_timeout, lumi.fromZigbee.RTCGQ11LM_illuminance],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.RTCGQ13LM_occupancy, lumi.fromZigbee.lumi_specific, fz.battery],
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.lumi_cube_action_multistate, lumi.fromZigbee.lumi_cube_action_analog],
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.JTYJGD01LMBW_smoke],
    ...
    },
    {
        ...
        fromZigbee: [fz.ias_gas_alarm_1, lumi.fromZigbee.JTQJBF01LMBW_sensitivity, lumi.fromZigbee.JTQJBF01LMBW_gas_density],
        toZigbee: [lumi.toZigbee.JTQJBF01LMBW_JTYJGD01LMBW_sensitivity, lumi.toZigbee.JTQJBF01LMBW_JTYJGD01LMBW_selfest],
        exposes: [
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.DJT11LM_vibration],
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.DJT12LM_vibration],
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.ZNMS12LM_ZNMS13LM_closuresDoorLock_report, lumi.fromZigbee.ZNMS12LM_low_battery],
        toZigbee: [],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.ZNMS12LM_ZNMS13LM_closuresDoorLock_report, fz.ignore_basic_report],
        toZigbee: [],
        exposes: [
    ...
    },
    {
        ...
        vendor: 'Aqara',
        fromZigbee: [lumi.fromZigbee.ZNMS11LM_closuresDoorLock_report, fz.ignore_basic_report],
        toZigbee: [],
        exposes: [
            e.binary('state', ea.STATE, 'UNLOCK', 'LOCK'),
            e.binary('reverse', ea.STATE, 'UNLOCK', 'LOCK'),
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.aqara_opple_on, lumi.fromZigbee.aqara_opple_off, fz.battery,
            lumi.fromZigbee.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.aqara_opple_on, lumi.fromZigbee.aqara_opple_off,
            lumi.fromZigbee.aqara_opple_step, lumi.fromZigbee.aqara_opple_step_color_temp, fz.battery,
            lumi.fromZigbee.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
            'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
            'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.aqara_opple_on, lumi.fromZigbee.aqara_opple_off,
            lumi.fromZigbee.aqara_opple_step, lumi.fromZigbee.aqara_opple_move, lumi.fromZigbee.aqara_opple_stop,
            lumi.fromZigbee.aqara_opple_step_color_temp, lumi.fromZigbee.aqara_opple_move_color_temp,
            fz.battery, lumi.fromZigbee.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        exposes: [e.battery(), e.battery_voltage(), e.action([
            'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
            'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
            'button_3_hold', 'button_3_release', 'button_3_single', 'button_3_double', 'button_3_triple',
    ...
    },
    {
        ...
        fromZigbee: [fz.on_off, lumi.fromZigbee.ZNCJMB14LM],
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [fz.battery, lumi.fromZigbee.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [],
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2850_3000'}},
        fromZigbee: [lumi.fromZigbee.lumi_basic, lumi.fromZigbee.aqara_opple_multistate, lumi.fromZigbee.lumi_specific],
        toZigbee: [],
        endpoint: (device) => {
            return {left: 1, right: 2, both: 3};
        },
    ...
    },
    {
        ...
        fromZigbee: [lumi.fromZigbee.lumi_specific, lumi.fromZigbee.lumi_cube_t1_action_multistate,
            lumi.fromZigbee.lumi_cube_t1_action_analog, fz.ignore_onoff_report],
