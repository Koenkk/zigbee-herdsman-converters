...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        extend: [deviceEndpoints({endpoints: {l1: 1, l2: 2}}), lumiZigbeeOTA()],
    },
    {
    ...
    },
    {
        ...
        extend: [
            ...
            // lumiMiscellaneous(),
            battery({voltageToPercentage: {min: 2850, max: 3000}, voltage: true}),
            lumiZigbeeOTA(),
            quirkCheckinInterval('1_HOUR'),
        ],
    },
    ...
    },
    {
        ...
        fromZigbee: [
            ...
            lumi.fromZigbee.lumi_curtain_reverse,
            lumi.fromZigbee.lumi_curtain_speed,
            fz_curtain_traverse_time,
            fz_curtain_state,
            fz_curtain_adaptive_speed,
            fz_curtain_calibration_status,
            fz_curtain_manual_stop,
            fz_curtain_position,
            fz_curtain_last_manual_operation,
        ],
        toZigbee: [
            tz_curtain_toggle,
            tz_curtain_position_state,
            tz_curtain_manual_calibration,
            lumi.toZigbee.lumi_curtain_hand_open,
            lumi.toZigbee.lumi_curtain_reverse,
            lumi.toZigbee.lumi_curtain_speed,
            tz_curtain_adaptive_speed,
            tz_curtain_manual_stop,
            tz_curtain_beep,
        ...
        exposes: [
            ...
            e.calibrated(),
            e.enum('beep', ea.SET, [0,1,2]).withDescription('Device will beep for chosen amount of seconds'),
        ],
