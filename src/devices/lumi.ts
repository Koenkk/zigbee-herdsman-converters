...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        extend: [
            lumiZigbeeOTA(),
            lumiPreventReset(),
            lumiOnOff({operationMode: true, powerOutageMemory: 'enum'}),
            lumiAction(),
            lumiElectricityMeter(),
            lumiPower(),
            lumiLedDisabledNight(),
    ...
    },
    {
        ...
        extend: [
            ...
            lumiOnOff({operationMode: true, powerOutageMemory: 'enum', endpointNames: ['top', 'bottom']}),
    ...
    },
    {
        ...
        extend: [
            ...
            lumiOnOff({operationMode: true, powerOutageMemory: 'enum', endpointNames: ['top', 'center', 'bottom']}),
