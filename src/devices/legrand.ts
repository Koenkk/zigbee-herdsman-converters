  ...
  import {eLegrand, fzLegrand, legrandExtend, legrandOptions, readInitialBatteryState, tzLegrand} from
  "../lib/legrand";
  ...
  \u0000\u0000\u0000\u0000",
          ...
          exposes: [
              ...
              e
                  ...
                  .withDescription("switch: allow on/off, auto will use wired action via C1/C2 on contactor for 
  example with HC/HP"),
          ],
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
  ...
  "haElectricalMeasurement"]);
      ...
      },
      {
          ...
          extend: [
              ...
              legrandExtend.addLegrandDevices3Cluster(),
              m.onOff(),
          ...
          toZigbee: [tzLegrand.legrand_device_mode, tzLegrand.identify, tzLegrand.auto_mode,
  tz.electrical_measurement_power],
          exposes: [
              e
                  .enum("device_mode", ea.ALL, ["switch", "auto"])
                  .withDescription("Switch: allow manual on/off, auto uses contact's C1/C2 wired actions for 
  Peak/Off-Peak electricity rates"),
      ...
      },
      {
          ...
          exposes: [
              ...
              e
                  .enum("device_mode", ea.ALL, ["switch", "auto"])
                  .withDescription("switch: allow on/off, auto will use wired action via C1/C2 on teleruptor with 
  buttons"),
          ],
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
  ...
  "closuresWindowCovering", "genIdentify"]);
          },
      },
      {
          ...
          fromZigbee: [fz.cover_position_tilt, fz.identify, fzLegrand.cluster_fc01,
  fzLegrand.calibration_mode(false), fzLegrand.command_cover],
          toZigbee: [tz.cover_state, tz.cover_position_tilt, tzLegrand.identify, tzLegrand.led_mode,
  tzLegrand.calibration_mode(false)],
          ...
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
              await reporting.bind(endpoint, coordinatorEndpoint, ["genBinaryInput", "closuresWindowCovering",
  "genIdentify"]);
  ...
  "genIdentify"]);
      ...
      },
      {
          ...
          fromZigbee: [fz.cover_position_tilt, fz.identify, fzLegrand.cluster_fc01, fzLegrand.calibration_mode(true),
  ...
  switch\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000"],
          ...
          ota: true,
          meta: {battery: {voltageToPercentage: {min: 2500, max: 3000}}, publishDuplicateTransaction: true},
          fromZigbee: [fz.identify, fz.command_on, fz.command_off, fz.command_toggle, fz.command_move,
  ...
  "brightness_move_down", "brightness_stop"])],
      ...
      },
      {
          ...
          ota: true,
          meta: {multiEndpoint: true, battery: {voltageToPercentage: {min: 2500, max: 3000}},
  ...
  "brightness_move_down", "brightness_stop"])],
      ...
      },
      {
          ...
          whiteLabel: [{vendor: "BTicino", description: "Wireless control module for a traditional two-way switch or 
  pushbutton", model: "3577C"}],
          ota: true,
  ...
  tz.level_config],
          exposes: [
              e.numeric("ballast_minimum_level", ea.ALL).withValueMin(1).withValueMax(254).withDescription("Specifies
   the minimum brightness value"),
              e.numeric("ballast_maximum_level", ea.ALL).withValueMin(1).withValueMax(254).withDescription("Specifies
   the maximum brightness value"),
              e.binary("device_mode", ea.ALL, "dimmer_on", "dimmer_off").withDescription("Allow the device to change 
  brightness"),
              eLegrand.ledInDark(),
              eLegrand.ledIfOn(),
          ],
          extend: [legrandExtend.addLegrandDevicesCluster(), m.light({configureReporting: true, levelConfig:
  {features: ["on_level"]}})],
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
              await reporting.bind(endpoint, coordinatorEndpoint, ["genIdentify", "genBinaryInput",
  "lightingBallastCfg"]);
          },
      },
      {
  ...
  switch\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000"],
      ...
      },
      {
          ...
          fromZigbee: [fz.legrand_scenes, fzLegrand.legrand_master_switch_center, fz.battery,
  fzLegrand.stop_poll_on_checkin],
          toZigbee: [],
          extend: [legrandExtend.addLegrandDevicesCluster()],
      ...
      },
      {
          ...
          ota: true,
          fromZigbee: [fz.identify, fz.metering, fz.electrical_measurement, fz.legrand_power_alarm,
  fzLegrand.cluster_fc01],
          toZigbee: [tzLegrand.led_mode, tz.electrical_measurement_power, tz.legrand_power_alarm,
  tzLegrand.identify],
          extend: [legrandExtend.addLegrandDevicesCluster()],
          exposes: [
              e.power().withAccess(ea.STATE_GET),
      ...
      {
          zigbeeModel: [" DIN power consumption module\u0000\u0000", " DIN power consumption module", "Smart shedder 
  module"],
          model: "412015",
          vendor: "Legrand",
          description: "DIN power consumption module",
          whiteLabel: [
              {vendor: "Legrand", description: "DIN power consumption module", model: "412172", fingerprint:
  [{modelID: " Smart shedder module"}]},
              {vendor: "BTicino", description: "DIN power consumption module", model: "FC80GCS", fingerprint:
  [{modelID: " Smart shedder module"}]},
          ],
          ota: true,
          fromZigbee: [fz.identify, fz.metering, fz.electrical_measurement, fz.legrand_power_alarm,
  fzLegrand.cluster_fc01],
          toZigbee: [tzLegrand.led_mode, tzLegrand.identify, tz.electrical_measurement_power,
  tz.legrand_power_alarm],
          extend: [legrandExtend.addLegrandDevicesCluster()],
          exposes: [
              e.power().withAccess(ea.STATE_GET),
              e.power_apparent(),
      ...
      },
      {
          ...
          ota: true,
          meta: {battery: {voltageToPercentage: {min: 2500, max: 3000}}},
          fromZigbee: [fz.legrand_scenes, fz.battery, fzLegrand.legrand_master_switch_center],
          toZigbee: [],
          extend: [legrandExtend.addLegrandDevicesCluster()],
          exposes: [e.battery(), e.action(["enter", "leave", "sleep", "wakeup", "center"])],
          configure: async (device, coordinatorEndpoint) => {
      ...
      },
      {
          ...
          vendor: "Legrand",
          description: "Wireless and batteryless scenario switch (home arrival/departure, 1-4 switches, daytime 
  day/night)",
          ota: true,
  ...
  u0000\u0000\u0000\u0000\u0000"],
          ...
          ota: true,
          fromZigbee: [fzLegrand.cluster_fc01, fzLegrand.legrand_pilot_wire_mode, fz.on_off,
  fz.electrical_measurement, fz.power_on_behavior],
          toZigbee: [
              tzLegrand.legrand_device_mode,
              tzLegrand.legrand_pilot_wire_mode,
              tz.on_off,
              tz.electrical_measurement_power,
              tz.power_on_behavior,
          ],
          extend: [legrandExtend.addLegrandDevicesCluster(), legrandExtend.addLegrandDevices2Cluster()],
          exposes: [
              ...
              e
                  .power_on_behavior()
                  .withDescription("Controls the behavior when the device is powered on. Works only when the pilot 
  wire is deactivated"),
          ],
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
  ...
  "manuSpecificLegrandDevices2"]);
      ...
      },
      {
          ...
          exposes: [e.switch().withEndpoint("left"), e.switch().withEndpoint("right"), eLegrand.ledInDark(),
  eLegrand.ledIfOn()],
          extend: [
              legrandExtend.addLegrandDevicesCluster(),
  ...
  "brightness_move_down", "brightness_stop"])],
      ...
      },
      {
          ...
          toZigbee: [tz.on_off, tzLegrand.led_mode, tzLegrand.identify, tz.power_on_behavior],
          extend: [legrandExtend.addLegrandDevicesCluster()],
          exposes: [e.switch(), e.action(["identify"]), eLegrand.ledInDark(), eLegrand.ledIfOn(),
  e.power_on_behavior()],
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
              await reporting.bind(endpoint, coordinatorEndpoint, ["genIdentify", "genOnOff"]);
  ...
  0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000",
          ...
          ota: true,
          fromZigbee: [fz.identify, fz.lighting_ballast_configuration, fzLegrand.cluster_fc01],
          toZigbee: [tz.on_off, tzLegrand.led_mode, tzLegrand.legrand_device_mode, tzLegrand.identify,
  tz.ballast_config],
          exposes: [
              e.numeric("ballast_minimum_level", ea.ALL).withValueMin(1).withValueMax(254).withDescription("Specifies
   the minimum brightness value"),
  ...
  brightness"),
          ...
          configure: async (device, coordinatorEndpoint) => {
              const endpoint = device.getEndpoint(1);
              await reporting.bind(endpoint, coordinatorEndpoint, ["genBinaryInput", "genOnOff",
  "lightingBallastCfg"]);
              await reporting.onOff(endpoint);
          },
      },
