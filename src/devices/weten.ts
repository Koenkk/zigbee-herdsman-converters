...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e.binary('buzzer_feedback', ea.STATE_SET, 'ON', 'OFF').withDescription('Enable buzzer feedback. It sounds on device actions like power state changes, child lock activation, etc.'),
            e.child_lock(),
