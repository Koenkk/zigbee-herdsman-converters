...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("holiday_temperature", ea.STATE_SET).withUnit("°C"),
            e.numeric("holiday_days", ea.STATE_SET).withUnit("days"),
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [101, "control_algorithm", tuya.valueConverterBasic.lookup({TPI_UFH: tuya.enum(0), TPI_RAD: tuya.enum(1), TPI_ELE: tuya.enum(2), HIS_04: tuya.enum(3), HIS_08: tuya.enum(4), HIS_12: tuya.enum(5), HIS_16: tuya.enum(6), HIS_20: tuya.enum(8), HIS_30: tuya.enum(9), HIS_40: tuya.enum(10)})],
                [106, "frost_set", tuya.valueConverter.divideBy10],
                [107, "valve_protection", tuya.valueConverter.onOff],
