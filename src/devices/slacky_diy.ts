        ...
        const fromZigbee: Fz.Converter[] = [
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.currentTier1SummDelivered !== undefined) {
                        ...
                        result.tariff1 = (Number.parseInt(data) / energyDivisor) * energyMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.currentTier2SummDelivered !== undefined) {
                        ...
                        result.tariff2 = (Number.parseInt(data) / energyDivisor) * energyMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.currentTier3SummDelivered !== undefined) {
                        ...
                        result.tariff3 = (Number.parseInt(data) / energyDivisor) * energyMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.currentTier4SummDelivered !== undefined) {
                        ...
                        result.tariff4 = (Number.parseInt(data) / energyDivisor) * energyMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.currentSummDelivered !== undefined) {
                        ...
                        result.tariff_summ = (Number.parseInt(data) / energyDivisor) * energyMultiplier;
                    }
                    return result;
                },
            },
            ...
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.rmsVoltage !== undefined) {
                        ...
                        result.voltage = (data / voltageDivisor) * voltageMultiplier;
            ...
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.acVoltageMultiplier !== undefined) {
                        ...
                        voltageMultiplier = data;
                        result.v_multiplier = voltageMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.acVoltageDivisor !== undefined) {
                        ...
                        voltageDivisor = data;
                        result.v_divisor = voltageDivisor;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.instantaneousLineCurrent !== undefined) {
                        ...
                        result.current = (data / currentDivisor) * currentMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.acCurrentMultiplier !== undefined) {
                        ...
                        result.c_multiplier = currentMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.acCurrentDivisor !== undefined) {
                        ...
                        currentDivisor = data;
                        result.c_divisor = currentDivisor;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.apparentPower !== undefined) {
                        ...
                        result.power = (data / powerDivisor) * powerMultiplier;
                    }
                    return result;
                },
            },
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (msg.data.acPowerMultiplier !== undefined) {
                        ...
                        powerMultiplier = data;
                        result.p_multiplier = powerMultiplier;
                    }
                    return result;
                },
            },
