    ...
    convertSet: async (entity, key, value, meta) => {
        ...
        if ('color' in meta.message || key === 'color') {
            ...
            const dp61Payload = [
                ...
                (h >> 8) & 0xFF, h & 0xFF,             
                (sat1000 >> 8) & 0xFF, sat1000 & 0xFF,        
                (val1000 >> 8) & 0xFF, val1000 & 0xFF         
            ];
    ...
    },
    {
        ...
        exposes: [
            ...
            e.enum('scene', exposes.access.STATE_SET, [
                'ice_land_blue', 'glacier_express', 'sea_of_clouds', 'fireworks_at_sea', 'firefly_night',
                'grass_land', 'northern_lights', 'late_autumn', 'game', 'holiday', 'party', 'trend',
                'meditation', 'dating', 'valentines_day', 'neon_world'
