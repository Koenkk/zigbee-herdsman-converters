    ...
    heimanClusterSpecial: () =>
        m.deviceAddCustomCluster("heimanClusterSpecial", {
            ...
            attributes: {
                ...
                lightEffectCount: {name: "lightEffectCount", ID: 0x2028, type: Zcl.DataType.UINT8},
                lightPixelCount: {name: "lightPixelCount", ID: 0x2029, type: Zcl.DataType.UINT8, write: true},
            },
            commands: {
                cameraActiveTrigger: {
                    ID: 0x01,
