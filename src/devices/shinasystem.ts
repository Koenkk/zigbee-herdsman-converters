...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        extend: [onOff({powerOnBehavior: false, configureReporting: true})],
    },
    {
        ...
        extend: [onOff({endpoints: {top: 1, bottom: 2}, powerOnBehavior: false, configureReporting: true})],
    },
    {
        ...
        extend: [onOff({endpoints: {top: 1, center: 2, bottom: 3}, powerOnBehavior: false, configureReporting: true})],
    },
    {
        ...
        extend: [onOff({endpoints: {top_left: 1, bottom_left: 2, top_right: 3, bottom_right: 4}, powerOnBehavior: false, configureReporting: true})],
    },
    {
    ...
    },
    {
        ...
        extend: [onOff({endpoints: {top_left: 1, center_left: 2, bottom_left: 3, top_right: 4, center_right: 5, bottom_right: 6},
            powerOnBehavior: false, configureReporting: true})],
    },
    {
