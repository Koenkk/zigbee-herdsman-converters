...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        extend: [deviceEndpoints({"endpoints":{"left":1,"right":2,"left_sw":21,"right_sw":22}}), identify(), onOff({"powerOnBehavior":false,"endpointNames":["left","right"]}), commandsOnOff({"endpointNames":["left_sw","right_sw"]})],
        meta: {"multiEndpoint":true},
    },
