...
const COLOR_LOOKUP = {
    'red': tuya.enum(0), 'orange': tuya.enum(1), 'green': tuya.enum(2), 
    'cyan': tuya.enum(3), 'blue': tuya.enum(4), 'purple': tuya.enum(5), 
    'magenta': tuya.enum(6), 'cold_white': tuya.enum(7), 'warm_yellow': tuya.enum(8)
};
...
const commonExposes = [
    ...
    e.enum('on_color', ea.STATE_SET, Object.keys(COLOR_LOOKUP)).withDescription('Light-on color'),
    e.enum('off_color', ea.STATE_SET, Object.keys(COLOR_LOOKUP)).withDescription('Light-off color'),
];

const commonTuyaDatapoints = [
    ...
    [102, 'on_color', tuya.valueConverterBasic.lookup(COLOR_LOOKUP)],
    [103, 'off_color', tuya.valueConverterBasic.lookup(COLOR_LOOKUP)],
