...
const definitions: DefinitionWithExtend[] = [
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Lidl", "HG07834B", "Livarno Lux E14 candle RGB", [
        "_TZ3000_th6zqqy6",
        "_TZ3000_wr6g6olr",
      ]),
      tuya.whitelabel(
      ...
      tuya.whitelabel("Lidl", "HG07834C", "Livarno Lux E27 bulb RGB", [
        "_TZ3000_qd7hej8u",
      ]),
  ...
  },
  {
    ...
    exposes: (device) => {
      ...
      if (
        ...
        device?.manufacturerName !== "_TZ3000_1dd0d5yi"
      ) {
        exps.push(
        ...
        [
          ...
          "schedule",
          {
            ...
            from: (v: number[], meta) => {
              ...
              for (let i = 0; i < 12; i++) {
                r += `${v[i * 3].toString().padStart(2, "0")}:${v[i * 3 + 1]
                  .toString()
                  .padStart(2, "0")}/${v[i * 3 + 2] / 2}`;
  ...
  },
  {
    ...
    exposes: (device, options) => {
      ...
      if (
        device?.manufacturerName !== "_TZ3000_303avxxt" &&
        device?.manufacturerName !== "_TZ3000_zjchz7pd"
      ) {
        exposes.push(
          e.temperature(),
          e
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Tomzn", "TOB9Z-M", "Smart circuit breaker", [
        "_TZ3000_303avxxt",
      ]),
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        ...
        .withDescription("Touch controll"),
    ],
    configure: async (device, coordinatorEndpoint) => {
      await tuya.configureMagicPacket(device, coordinatorEndpoint);
      await reporting.bind(device.getEndpoint(1), coordinatorEndpoint, [
