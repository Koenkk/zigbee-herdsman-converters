...
export const definitions: DefinitionWithExtend[] = [
    ...
    {
               // fingerprint: tuya.fingerprint('TS0601', ['_TZE204_sdykkwsu']),  // Remove or comment out
         zigbeeModel: ["TS0601"],
         model: "ZDMS16-US-W2",
         vendor: "AVATTO",
         description: "Zigbee 2 channels Dimmer",
         ...
         whiteLabel: [tuya.whitelabel("AVATTO", "ZDMS16-US-W2", "2 gang smart dimmer", ["_TZE204_sdykkwsu"])],
     },
];
