...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e.binary("debug_switch", ea.STATE_SET, "on", "off").withDescription("Debug mode toggle"), // change to toggle
            e
            ...
            e.enum("start_noise_collect", ea.SET, ["start"]).withDescription("Start environmental background noise collection and auto adjust thresholds"), // only button to start noise collection
            e.enum("noise_collect_status", ea.STATE, ["start", "ongoing", "complete"]).withDescription("Environmental background noise collection status"), // status of noise collection
