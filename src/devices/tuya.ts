...
export const definitions: DefinitionWithExtend[] = [
    ...
    {     
        ...
        model: "M9Pro",
        vendor: "Tuya",
        description: "Smart 4 gang switch with neutral wire and motion sensing.  " +
        ...
        exposes: [
            ...
            ...[1, 2, 3].map((i) => e.enum('mode', ea.STATE_SET, ['switch', 'scene', 'smart_light', 'curtain'])
                .withEndpoint(`l${i}`).withDescription(`Switch ${i} mode`)),
            e.enum('mode', ea.STATE_SET, ['switch', 'scene', 'smart_light', 'curtain', 'thermostat']).withEndpoint('l4').withDescription("Switch 4 mode"),
            ...
            e.text('thermostat_name', ea.STATE_SET).withDescription("Name for Thermostat (max 8 chars displayed)"),
             ...
             e.enum('scene_switch', ea.STATE_SET, ['switch_1', 'switch_2', 'switch_3', 'switch_4',
                'switch_5', 'switch_6', 'switch_7', 'switch_8', 'switch_9'])
        ...
        meta: {
            ...
            tuyaDatapoints: [
                ...
                [17, "action", tuya.valueConverter.static("scene_0")],
                    [18, "mode_l1", tuya.valueConverterBasic.lookup({
                    'switch': tuya.enum(0),
                    'scene': tuya.enum(1),
                    'smart_light': tuya.enum(2),
                    'curtain': tuya.enum(3),
                })],
                [19, "mode_l2", tuya.valueConverterBasic.lookup({
                    'switch': tuya.enum(0),
                    'scene': tuya.enum(1),
                    'smart_light': tuya.enum(2),
                    'curtain': tuya.enum(3),
                })],
                [20, "mode_l3", tuya.valueConverterBasic.lookup({
                    'switch': tuya.enum(0),
                    'scene': tuya.enum(1),
                    'smart_light': tuya.enum(2),
                    'curtain': tuya.enum(3),
                })],
                [21, "mode_l4", tuya.valueConverterBasic.lookup({
                    'switch': tuya.enum(0),
                    'scene': tuya.enum(1),
                    'smart_light': tuya.enum(2),
                    'curtain': tuya.enum(3),
                ...
                [37, 'show_screen', tuya.valueConverterBasic.lookup({
                ...
                [102, "scene_switch", tuya.valueConverterBasic.lookup({
                ...
                [103, "name_l1", {
                    ...
                    to: (v, meta) => {return convLocal.name.to(v.slice(0, 8), meta);}}],
                [104, "name_l2", {
                    from: convLocal.name.from,
                    to: (v, meta) => {return convLocal.name.to(v.slice(0, 8), meta);}}],
                [105, "name_l3", {
