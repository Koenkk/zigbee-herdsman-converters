...
const tzLocal = {
  ...
  TS110E_options: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      if (key === "min_brightness" || key == "max_brightness") {
        ...
        payload = {
          [id]: {
            value: utils.mapNumberRange(
              utils.toNumber(value, key),
              1,
              255,
              0,
              1000
  ...
  TS110E_light_onoff_brightness: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      if (
        message.state === "ON" ||
        (typeof message.brightness === "number" && message.brightness > 1)
      ) {
...
const fzLocal = {
  ...
  TS110E: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      if (msg.data.hasOwnProperty("64515")) {
        result["min_brightness"] = utils.mapNumberRange(
          msg.data["64515"],
          0,
          1000,
          1,
      ...
      if (msg.data.hasOwnProperty("64516")) {
        result["max_brightness"] = utils.mapNumberRange(
          msg.data["64516"],
          0,
          1000,
          1,
      ...
      if (msg.data.hasOwnProperty("61440")) {
        result["brightness"] = utils.mapNumberRange(
          msg.data["61440"],
          0,
          1000,
          0,
  ...
  TS110E_switch_type: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      if (msg.data.hasOwnProperty("64514")) {
        ...
        const propertyName = utils.postfixWithEndpointName(
          "switch_type",
          msg,
          model,
          meta
  ...
  humidity10: {
    ...
    type: ["attributeReport", "readResponse"],
    options: [
      exposes.options.precision("humidity"),
      exposes.options.calibration("humidity"),
    ],
    convert: (model, msg, publish, options, meta) => {
      const humidity = parseFloat(msg.data["measuredValue"]) / 10.0;
      if (humidity >= 0 && humidity <= 100) {
        return {
          humidity: utils.calibrateAndPrecisionRoundOptions(
            humidity,
            options,
            "humidity"
          ),
  ...
  TS011F_electrical_measurement: {
    ...
    convert: async (model, msg, publish, options, meta) => {
      const result = await fz.electrical_measurement.convert(
        model,
        msg,
        publish,
        options,
          ...
          if (key in result) {
            ...
            if (value === 0) {
              ...
              globalStore.putValue(
                msg.endpoint,
                key,
                setTimeout(() => publish({ [key]: value }), time * 1000)
              );
              delete result[key];
            }
          }
...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Sber", "SBDV-00030", "Door sensor", [
        "_TYZB01_epni2jgy",
      ]),
    ...
    exposes: (device, options) => {
      ...
      if (
        !device ||
        !["_TZ3000_2mbfxlzr", "_TZ3000_n2egfsli", "_TZ3000_yfekcy3n"].includes(
  ...
  {
    fingerprint: [
      { modelID: "TS011F", manufacturerName: "_TZ3000_mvn6jl7x" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_raviyuvk" },
      { modelID: "TS011F", manufacturerName: "_TYZB01_hlla45kx" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_92qd4sqa" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_zwaadvus" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_k6fvknrr" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_6s5dc9lx" },
      { modelID: "TS011F", manufacturerName: "_TZ3000_rgpqqmbj" },
    ],
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("TuYa", "TS0505B_1_3", "Zigbee 10W Downlight RGB CCW", [
        "_TZ3210_it1u8ahz",
      ]),
      ...
      tuya.whitelabel("Moes", "ZLD-RCW_2", "RGB+CCT LED bulb", [
        "_TZ3210_rcggc0ys",
      ]),
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Tuya", "TS0505B_1_2", "Zigbee GU10/E14 5W smart bulb", [
        "_TZ3210_it1u8ahz",
      ]),
    ],
  ...
  },
  {
    ...
    whiteLabel: [{ vendor: "Moes", model: "MS-105B-M" }],
  },
  {
  ...
  },
  {
    fingerprint: [
      ...
      { modelID: "", manufacturerName: "_TZ3000_zl1kmjqx" },
    ],
    model: "IH-K009",
    vendor: "TuYa",
    description: "Temperature & humidity sensor",
  ...
  },
  {
    ...
    fingerprint: [
      ...
      { modelID: "TS0041A", manufacturerName: "_TYZB01_ub7urdza" },
    ],
    model: "TS0041",
    vendor: "TuYa",
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Sber", "SBDV-00032", "Wireless switch with 1 button", [
        "_TYZB01_ub7urdza",
      ]),
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("AVATTO", "ZWSM16-2-Zigbee", "2 gang switch", [
        "_TZ3000_mtnpt6ws",
      ]),
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .composite("programming_mode", "programming_mode", ea.STATE)
        .withDescription(
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        ...
        .withDescription("Opening mode"),
      e
        .enum("set_upper_limit", ea.STATE_SET, ["SET"])
        .withDescription(
          "Set the upper limit, to reset limits use factory_reset"
        ),
      e
        .enum("set_bottom_limit", ea.STATE_SET, ["SET"])
        .withDescription(
          "Set the bottom limit, to reset limits use factory_reset"
        ),
      e
        .binary("factory_reset", ea.STATE_SET, true, false)
        ...
        [
          ...
          null,
          {
            from: (v) => {
              ...
              const systemModeLookup: KeyValueNumberString = {
                0: "auto",
                1: "auto",
                2: "off",
                3: "heat",
              ...
              return {
                preset: presetLookup[v],
                system_mode: systemModeLookup[v],
              };
            },
          },
        ],
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Moes", "ZS-US2-WH-MS", "Smart light switch - 2 gang", [
        "_TZ3000_18ejxno0",
      ]),
    ],
    extend: tuya.extend.switch({
  ...
  {
    fingerprint: [
      { modelID: "TS0006", manufacturerName: "_TYZB01_ltundz9m" },
  ...
  {
    fingerprint: [
      { modelID: "TS0210", manufacturerName: "_TYZB01_3zv6oleo" },
...

  {
    ...
    whiteLabel: [
      tuya.whitelabel("Loginovo", "ZG-101ZL", "Smart button", [
        "_TZ3000_ja5osu5g",
      ]),
    ],
    fromZigbee: [
  ...
  },
  {
    ...
    fromZigbee: extend
      .light_onoff_brightness({
        ...
        disableMoveStep: true,
        disableTransition: true,
      })
      .fromZigbee.concat([
        tuya.fz.power_on_behavior_1,
        fzLocal.TS110E_switch_type,
        fzLocal.TS110E,
      ]),
  ...
  },
  {
    ...
    fromZigbee: [
      fzLocal.TS110E,
      fzLocal.TS110E_light_type,
      tuya.fz.power_on_behavior_1,
      fz.on_off,
    ],
    toZigbee: [
      tzLocal.TS110E_onoff_brightness,
      tzLocal.TS110E_options,
      tuya.tz.power_on_behavior_1,
  ...
  {
    fingerprint: [{ modelID: "TS0001", manufacturerName: "_TZ3000_bmqxalil" }],
    ...
    whiteLabel: [
      tuya.whitelabel("Homeetec", "37022454", "1 Gang switch with backlight", [
        "_TZ3000_bmqxalil",
      ]),
    ],
  },
  {
    fingerprint: [{ modelID: "TS0002", manufacturerName: "_TZ3000_in5qxhtt" }],
  ...
  {
    fingerprint: [{ modelID: "TS0003", manufacturerName: "_TZ3000_pv4puuxi" }],
    ...
    whiteLabel: [
      tuya.whitelabel("Homeetec", "37022474", "3 Gang switch with backlight", [
        "_TZ3000_pv4puuxi",
      ]),
    ],
  },
  ...
  {
    fingerprint: [{ modelID: "TS0601", manufacturerName: "_TZE200_vmcgja59" }],
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Sber", "SBDV-00029", "Motion sensor", [
        "_TYZB01_2jzbhomb",
      ]),
    ],
  },
  ...
  },
  {
    ...
    exposes: [
      ...
      e.presence(),
      e
        .enum("presence_state", ea.STATE, ["none", "present", "moving"])
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .numeric("update_frequency", ea.STATE)
        .withUnit("s")
