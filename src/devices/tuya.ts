...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("min_distance", ea.STATE_SET).withValueMin(0).withValueMax(8.4).withValueStep(0.1).withUnit("m").withDescription("Minimum detection distance"),
            e.numeric("max_distance", ea.STATE_SET).withValueMin(0).withValueMax(8.4).withValueStep(0.1).withUnit("m").withDescription("Maximum detection distance"),
            ...
            e.enum("led_mode", ea.STATE_SET, ["silence", "status"]).withDescription("LED indicator mode"), // same as in the app
            e.numeric("delay_time", ea.STATE_SET).withValueMin(5).withValueMax(3600).withUnit("s").withDescription("Departure delay time"),
            e.numeric("block_time", ea.STATE_SET).withValueMin(0).withValueMax(10).withValueStep(0.5).withUnit("s").withDescription("Block time after unoccupancy"), // same as in the app
            e.enum("judge_logic", ea.STATE_SET, ["large_move", "small_move", "custom_move"]).withDescription("Presence detection algorithm"), // same as in the app
            e.enum("environmental_noise_collect", ea.STATE_SET, ["start", "ongoing", "complete"]).withDescription("Environmental background noise collection status"),
            ...
            e.enum('scene_mode', ea.STATE_SET, [
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [122, "judge_logic", tuya.valueConverterBasic.lookup({large_move: tuya.enum(0), small_move: tuya.enum(1), custom_move: tuya.enum(2)})],
                [123, "environmental_noise_collect", tuya.valueConverterBasic.lookup({start: tuya.enum(0), ongoing: tuya.enum(1), complete: tuya.enum(2)})],
                ...
                [126, "presence_sensitivity", tuya.valueConverterBasic.lookup({high: tuya.enum(0), medium: tuya.enum(1), low: tuya.enum(2), custom: tuya.enum(3)})],
                [127, "motion_sensitivity", tuya.valueConverterBasic.lookup({high: tuya.enum(0), medium: tuya.enum(1), low: tuya.enum(2), custom: tuya.enum(3)})],
