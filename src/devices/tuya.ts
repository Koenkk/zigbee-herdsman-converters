...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                [3, 'soil_moisture', tuya.valueConverter.raw],
                [5, 'soil_temperature', tuya.valueConverter.divideBy10],
                [9, 'temperature_unit', tuya.valueConverter.temperatureUnitEnum],
                [14, 'battery_state', tuya.valueConverter.batteryState],
                [15, 'battery', tuya.valueConverter.raw],
                [101, 'temperature_alarm', tuya.valueConverter.raw],
                [102, 'soil_moisture_alarm', tuya.valueConverter.raw],
                [103, 'max_soil_temperature_set', tuya.valueConverter.raw],
                [104, 'min_soil_temperature_set', tuya.valueConverter.raw],
                [105, 'max_soil_moisture_set', tuya.valueConverter.raw],
                [106, 'min_soil_moisture_set', tuya.valueConverter.raw],
                [107, 'soil_temperature_sensitivity', tuya.valueConverter.raw],
                [108, 'soil_moisture_sensitivity', tuya.valueConverter.raw],
                [109, 'detection_interval', tuya.valueConverter.raw],
                [110, 'temperature', tuya.valueConverter.raw],
                [111, 'temperature_sensitivity', tuya.valueConverter.raw],
                [112, 'max_temperature_set', tuya.valueConverter.raw],
                [113, 'min_temperature_set', tuya.valueConverter.raw],
            ],
        },
    },
    {
