...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        model: "TS0601_F3-Pro",
        vendor: "Tuya",
        description: "Tuya F3-Pro smart panel. 4-gang switch with scene, dimmer, and curtain control",
        extend: [tuya.modernExtend.tuyaBase({dp: true, forceTimeUpdates: true, queryOnConfigure: true})],
        ...
        exposes: [
            ...
            e.text("scene_name_1", ea.STATE_SET).withDescription("Name for Scene 1"),
            e.text("scene_name_2", ea.STATE_SET).withDescription("Name for Scene 2"),
            e.text("scene_name_3", ea.STATE_SET).withDescription("Name for Scene 3"),
            e.text("scene_name_4", ea.STATE_SET).withDescription("Name for Scene 4"),
            e.text("scene_name_5", ea.STATE_SET).withDescription("Name for Scene 5"),
            e.text("scene_name_6", ea.STATE_SET).withDescription("Name for Scene 6"),
            e.text("scene_name_7", ea.STATE_SET).withDescription("Name for Scene 7"),
            e.text("scene_name_8", ea.STATE_SET).withDescription("Name for Scene 8"),
            ...
            e.binary("led_switch1", ea.ALL, "ON", "OFF").withDescription("Switch of LED 1"),
            e.numeric("led_warm1", ea.STATE_SET).withDescription("Color temperature of LED 1").withValueMin(1).withValueMax(100),
            e.numeric("led_bright1", ea.STATE_SET).withDescription("Brightness of LED 1").withValueMin(1).withValueMax(100),

            e.binary("led_switch2", ea.ALL, "ON", "OFF").withDescription("Switch of LED 2"),
            e.numeric("led_warm2", ea.STATE_SET).withDescription("Color temperature of LED 2").withValueMin(1).withValueMax(100),
            e.numeric("led_bright2", ea.STATE_SET).withDescription("Brightness of LED 2").withValueMin(1).withValueMax(100),

            e.binary("led_switch3", ea.ALL, "ON", "OFF").withDescription("Switch of LED 3"),
            e.numeric("led_warm3", ea.STATE_SET).withDescription("Color temperature of LED 3").withValueMin(1).withValueMax(100),
            e.numeric("led_bright3", ea.STATE_SET).withDescription("Brightness of LED 3").withValueMin(1).withValueMax(100),

            e.binary("led_switch4", ea.ALL, "ON", "OFF").withDescription("Switch of LED 4"),
            e.numeric("led_warm4", ea.STATE_SET).withDescription("Color temperature of LED 4").withValueMin(1).withValueMax(100),
            e.numeric("led_bright4", ea.STATE_SET).withDescription("Brightness of LED 4").withValueMin(1).withValueMax(100),

            e.enum("cover_state1", ea.STATE_SET, ["open", "stop", "close"]).withDescription("State of Cover 1"),
            e.numeric("cover_position1", ea.STATE_SET).withDescription("Position of Cover 1").withUnit("%").withValueMin(0).withValueMax(100),

            e.enum("cover_state2", ea.STATE_SET, ["open", "stop", "close"]).withDescription("State of Cover 2"),
            e.numeric("cover_position2", ea.STATE_SET).withDescription("Position of Cover 2").withUnit("%").withValueMin(0).withValueMax(100),

            e.enum("cover_state3", ea.STATE_SET, ["open", "stop", "close"]).withDescription("State of Cover 3"),
            e.numeric("cover_position3", ea.STATE_SET).withDescription("Position of Cover 3").withUnit("%").withValueMin(0).withValueMax(100),

            e.enum("cover_state4", ea.STATE_SET, ["open", "stop", "close"]).withDescription("State of Cover 4"),
            e.numeric("cover_position4", ea.STATE_SET).withDescription("Position of Cover 4").withUnit("%").withValueMin(0).withValueMax(100),
        ],
        ...
        meta: {
            ...
            tuyaDatapoints: [
                ...
                [102, "led_bright1", tuya.valueConverter.raw],
                [103, "led_bright2", tuya.valueConverter.raw],
                [105, "led_bright3", tuya.valueConverter.raw],
                [107, "led_bright4", tuya.valueConverter.raw],

                [109, "led_warm1", tuya.valueConverter.raw],
                [110, "led_warm2", tuya.valueConverter.raw],
                [111, "led_warm3", tuya.valueConverter.raw],
                [112, "led_warm4", tuya.valueConverter.raw],

                [113, "cover_position1", tuya.valueConverter.raw],
                [114, "cover_position2", tuya.valueConverter.raw],
                [115, "cover_position3", tuya.valueConverter.raw],
                [116, "cover_position4", tuya.valueConverter.raw],
                ...
                [133, "cover_state1", tuya.valueConverterBasic.lookup({open: tuya.enum(0), stop: tuya.enum(1), close: tuya.enum(2)})],
                [134, "cover_state2", tuya.valueConverterBasic.lookup({open: tuya.enum(0), stop: tuya.enum(1), close: tuya.enum(2)})],
                [135, "cover_state3", tuya.valueConverterBasic.lookup({open: tuya.enum(0), stop: tuya.enum(1), close: tuya.enum(2)})],
                [136, "cover_state4", tuya.valueConverterBasic.lookup({open: tuya.enum(0), stop: tuya.enum(1), close: tuya.enum(2)})],
                ...
                [141, "scene_name_1", tuya.valueConverter.utf16BEHexString],
                [142, "scene_name_2", tuya.valueConverter.utf16BEHexString],
                [143, "scene_name_3", tuya.valueConverter.utf16BEHexString],
                [144, "scene_name_4", tuya.valueConverter.utf16BEHexString],
                [145, "scene_name_5", tuya.valueConverter.utf16BEHexString],
                [146, "scene_name_6", tuya.valueConverter.utf16BEHexString],
                [147, "scene_name_7", tuya.valueConverter.utf16BEHexString],
                [148, "scene_name_8", tuya.valueConverter.utf16BEHexString],
