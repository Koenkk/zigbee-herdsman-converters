...
const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        model: 'TE-1Z',
        vendor: 'Tuya',
        description: 'Tuya Floor Heating Thermostat',
        fromZigbee: [
            tuya.fz.datapoints,
        ],
        toZigbee: [
        ...
        exposes: [
            ...
            e.binary('high_temperature_protection_state', ea.STATE_SET, 'ON', 'OFF')
                .withDescription(
            ...
            e.numeric('high_temperature_protection_setting', ea.STATE_SET)
                .withUnit('°C')
                .withValueMin(20)
                .withValueMax(70)
                .withDescription('Alarm temperature max')
            ...
            e.numeric('low_temperature_protection_setting', ea.STATE_SET)
                .withUnit('°C')
                .withValueMin(1)
                .withValueMax(10)
                .withDescription('Alarm temperature min')
            ...
            e.numeric('temperature_sensor', ea.STATE)
                .withUnit('°C')
