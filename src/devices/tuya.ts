...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        whiteLabel: [{vendor: 'QA', model: 'QAT42ZT3'}],
        extend: [
            tuya.modernExtend.tuyaMagicPacket(),
    ...
    },
    {
        ...
        whiteLabel: [{vendor: 'QA', model: 'QAT42ZT1'}],
        extend: [
            tuya.modernExtend.tuyaMagicPacket(),
    ...
    },
    {
        ...
        whiteLabel: [{vendor: 'QA', model: 'QAT42ZT2'}],
        extend: [
            tuya.modernExtend.tuyaMagicPacket(),
            deviceEndpoints({endpoints: {'l1': 1, 'l2': 2}}),
    ...
    {
        fingerprint: tuya.fingerprint('TS1201', ['_TZ3290_jxvzqatwgsaqzx1u']),
        model: 'QAIRZPRO',
        vendor: 'QA',
        description: 'QA IR Hub',
        whiteLabel: [{vendor: 'QA', model: 'QAIRZPRO'}],
        fromZigbee: [
            zosung.fzZosung.zosung_send_ir_code_00, zosung.fzZosung.zosung_send_ir_code_01, zosung.fzZosung.zosung_send_ir_code_02,
            zosung.fzZosung.zosung_send_ir_code_03, zosung.fzZosung.zosung_send_ir_code_04, zosung.fzZosung.zosung_send_ir_code_05,
        ],
        toZigbee: [zosung.tzZosung.zosung_ir_code_to_send, zosung.tzZosung.zosung_learn_ir_code],
        exposes: [zosung.presetsZosung.learn_ir_code(), zosung.presetsZosung.learned_ir_code(), zosung.presetsZosung.ir_code_to_send()],
    },
    {
    ...
    },
    {
        ...
        model: 'QASZ24R',
        vendor: 'QA',
        description: 'QA mmWave 24Ghz relay 10A',
        configure: tuya.configureMagicPacket,
        fromZigbee: [tuya.fz.datapoints],
        toZigbee: [tuya.tz.datapoints],
        exposes: [
