...
const definitions: DefinitionWithExtend[] = [
    ...
    {
      fingerprint: [
        { modelID: 'TS0601', manufacturerName: '_TZE204_ltwbm23f' },
      ],
      model: 'TRV602Z',
      vendor: 'Tuya',
      description: 'Thermostatic radiator valve.',
      ...
      exposes: [
        ...
        e
          .enum('mode', ea.STATE_SET, ['standby', 'antifrost', 'eco', 'comfort', 'auto', 'on'])
      ...
      meta: {
        tuyaDatapoints: [
          ...
          [
            102,
            'schedule_monday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(1),
          ],
          [
            103,
            'schedule_tuesday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(2),
          ],
          [
            104,
            'schedule_wednesday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(3),
          ],
          [
            105,
            'schedule_thursday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(4),
          ],
          [
            106,
            'schedule_friday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(5),
          ],
          [
            107,
            'schedule_saturday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(6),
          ],
          [
            108,
            'schedule_sunday',
            tuya.valueConverter.thermostatScheduleDayMultiDP_TRV602Z_WithDayNumber(7),
          ],
          [
            110,
            'motor_thrust',
