...
const fzLocal = {
    ...
    TS011F_electrical_measurement: {
        ...
        convert: (model, msg, publish, options, meta) => {
            const result: KeyValue = fz.electrical_measurement.convert(model, msg, publish, options, meta);
    ...
    TS011F_threshold: {
        ...
        type: 'raw',
        convert: (model, msg, publish, options, meta) => {
            const splitToAttributes = (value: Buffer) => {
                const result: KeyValue = {};
...
const definitions: Definition[] = [
    ...
    },
    {
        fingerprint: tuya.fingerprint('TS0002', ['_TZ3000_01gpyda5', '_TZ3000_bvrlqyj7', '_TZ3000_7ed9cqgi',
            '_TZ3000_zmy4lslw', '_TZ3000_ruxexjfz', '_TZ3000_4xfqlgqo', '_TZ3000_eei0ubpy']),
