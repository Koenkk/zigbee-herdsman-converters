    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [28, 'schedule_monday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [29, 'schedule_tuesday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [30, 'schedule_wednesday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [31, 'schedule_thursday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [32, 'schedule_friday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [33, 'schedule_saturday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [34, 'schedule_sunday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [40, 'child_lock', tuya.valueConverter.lockUnlock],
                [45, 'error_status', tuya.valueConverter.raw],
                [101, 'schedule_monday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [102, 'schedule_tuesday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [103, 'schedule_wednesday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [104, 'schedule_thursday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [105, 'schedule_friday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [106, 'schedule_saturday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
                [107, 'schedule_sunday', tuya.valueConverter.thermostatScheduleDayMultiDP4],
            ],
        },
        exposes: [
