      ...
      priv = {
        ...
        flush: function (
          ...
          if (
            ...
            const signedPower = options.hasOwnProperty(signedPowerKey)
  ...
  energyFlowPJ1203A: (channel: string) => {
    return {
      from: (v: number, meta: Fz.Meta, options: KeyValue) => {
        ...
        const lateEnergyFlow = options.hasOwnProperty(lateEnergyFlowKey)
      ...
      switch (key) {
        ...
        case "over_voltage_threshold": {
          ...
          const buf = Buffer.from([
            ...
            utils.getFromLookup(state, onOffLookup),
            0,
            utils.toNumber(value, "over_voltage_breaker"),
          ]);
          await entity.command("manuSpecificTuya_3", "setOptions3", {
            data: buf,
          });
...
const fzLocal = {
  ...
  TS0222_humidity: {
    ...
    convert: async (model, msg, publish, options, meta) => {
      const result = await fz.humidity.convert(
        model,
        msg,
        publish,
        options,
  ...
  TS011F_electrical_measurement: {
    ...
    convert: async (model, msg, publish, options, meta) => {
      const result =
        (await fz.electrical_measurement.convert(
          model,
          msg,
          publish,
          options,
...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Adaprox", "LKWSZ211", "Remote wireless switch (2-key)", [
        "_TZ3210_3ulg9kpo",
      ]),
    ],
  },
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel(
        ...
        ["_TZ3210_jd3z4yig", "_TZ3210_r5afgmkl"]
      ),
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .binary("cleaning_reminder", ea.STATE, "ON", "OFF")
  ...
  },
  {
    ...
    exposes: (device) => {
      ...
      if (
        !device ||
        device.manufacturerName !== ("_TZ3210_xbpt8ewc" || "_TZ3000_1dd0d5yi")
      ) {
        exps.push(
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Nous", "E8", "Smoke sensor", ["_TZE200_0zaf1cr8"]),
    ],
  },
  {
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Homeetec", "37022463", "2 Gang switch with backlight", [
        "_TZ3000_in5qxhtt",
      ]),
      tuya.whitelabel("RoomsAI", "37022463", "2 Gang switch with backlight", [
        "_TZ3000_ogpla3lh",
      ]),
    ],
  },
