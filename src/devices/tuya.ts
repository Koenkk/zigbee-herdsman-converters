...
export const definitions: DefinitionWithExtend[] = [
    ...
    {
        fingerprint: tuya.fingerprint("TS0601", ["_TZE204_q22avxbv", "_TZE204_mrffaamu", "_TZE204_tzreobvu", "_TZE284_mrffaamu", "TZE284_tzreobvu"]),
        model: "TOQCB2-80",
        vendor: "Tongou",
        ...
        meta: {
            tuyaDatapoints: [
                [
                    2,
                    "preset",
                    tuya.valueConverterBasic.lookup({auto: tuya.enum(0), manual: tuya.enum(1), holiday: tuya.enum(2), confort: tuya.enum(3)}),
                ],
                [16, "current_heating_setpoint", tuya.valueConverter.divideBy2],
