      ...
      priv = {
        ...
        flush: function (
          ...
          if (
            ...
            const signedPower =
              options[signedPowerKey] !== undefined
                ? options[signedPowerKey]
                : false;
            if (signedPower) {
    ...
    return {
      from: (v: number, meta: Fz.Meta, options: KeyValue) => {
        ...
        const lateEnergyFlow =
          options[lateEnergyFlowKey] !== undefined
  ...
  TS030F_border: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      await entity.write(0xe001, {
        0xe001: { value: utils.getFromLookup(value, lookup), type: 0x30 },
      });
    },
  ...
  TS0224: {
    ...
    convertSet: async (entity, key, value, meta) => {
      if (key === "light") {
        ...
        await entity.write(
          "ssIasWd",
          { 0x0002: { value: lookupValue, type: 0x0a } },
          utils.getOptions(meta.mapped, entity),
        );
      }
...
const fzLocal = {
  ...
  TS011F_electrical_measurement: {
    ...
    convert: async (model, msg, publish, options, meta) => {
      const result =
        fz.electrical_measurement.convert(model, msg, publish, options, meta) ??
        {};
...
const modernExtendLocal = {
  dpTHZBSettings(): ModernExtend {
    const exp = e
      ...
      .withFeature(
        e
          .enum("enabled", ea.STATE_SET, ["on", "off", "none"])
          .withDescription("Enable auto settings"),
      )
      .withFeature(
        e
          .enum("temp_greater_then", ea.STATE_SET, ["on", "off", "none"])
      ...
      .withFeature(
        e
          .enum("temp_lower_then", ea.STATE_SET, ["on", "off", "none"])
          .withDescription("Lower action"),
      )
      .withFeature(
        e
    ...
    const handlers: [Fz.Converter[], Tz.Converter[]] = tuya.getHandlersForDP(
      "auto_settings",
      0x77,
      tuya.dataTypes.string,
      {
        from: (value: string) => {
          let result = {
            enabled: "none",
          ...
          if (buf.length > 0) {
            ...
            result = {
              ...
              temp_greater_then:
                gr !== 0xff ? { 0x01: "on", 0x00: "off" }[grAction] : "none",
              temp_greater_value: grValue,
              temp_lower_then:
                lo !== 0xff ? { 0x01: "on", 0x00: "off" }[loAction] : "none",
...
const definitions: DefinitionWithExtend[] = [
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Tuya", "TS0205_smoke_2", "Smoke sensor", [
        "_TZ3210_up3pngle",
      ]),
    ],
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Linkoze", "LKWSZ211", "Wireless switch (2-key)", [
        "_TZ3210_3ulg9kpo",
      ]),
    ],
  },
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .enum("temperature_alarm", ea.STATE_SET, [
          "lower_alarm",
          "upper_alarm",
          "cancel",
        ])
      ...
      e
        .enum("humidity_alarm", ea.STATE_SET, [
          "lower_alarm",
          "upper_alarm",
          "cancel",
        ])
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Novadigital", "NT-S2", "2 gang socket outlet BR", [
        "_TZ3000_sgb0xhwn",
      ]),
    ],
    endpoint: (device) => {
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("Tuya", "HG08007", "Livarno Home outdoor LED band", [
        "_TZ3210_zbabx9wh",
      ]),
      tuya.whitelabel(
        "Lidl",
      ...
      tuya.whitelabel("MiBoxer", "FUT106ZR", "GU10 bulb", [
        "_TZB210_rwy5hexp",
        "_TZB210_lnnkh3f9",
      ]),
      tuya.whitelabel(
  ...
  },
  {
    ...
    fromZigbee: [tuya.fz.datapoints],
    extend: [
      iasZoneAlarm({ zoneType: "rain", zoneAttributes: ["alarm_1"] }),
      battery({ percentageReporting: false }),
    ],
    exposes: [
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Lidl", "HG06492B", "Livarno Lux E14 candle CCT", [
        "_TZ3000_oborybow",
      ]),
      tuya.whitelabel(
        "Lidl",
      ...
      tuyaDatapoints: [
          ...
          null,
          {
            from: (v, meta) => {
              return v === true
                ? {
                    state: "ON",
                    system_mode: meta.state.system_mode_device
                      ? meta.state.system_mode_device
                      : "cool",
                  }
        ...
        [
          ...
          null,
          {
            from: (v, meta) => {
              return {
                current_cooling_setpoint: v,
                current_heating_setpoint: v,
              };
            },
          },
        ],
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel(
        "Tuya",
        "TS0001_power_polling",
        "Switch with power monitoring (via polling)",
        ["_TZ3000_x3ewpzyr"],
      ),
    ],
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("AVATTO", "ME168", "Thermostatic radiator valve", [
        "_TZE200_p3dbf6qs",
        "_TZE200_rxntag7i",
      ]),
  ...
  },
  {
    ...
    whiteLabel: [
      ...
      tuya.whitelabel("RTX", "ZCR1-40EM", "Zigbee DIN energy meter", [
        "_TZE204_wbhaespm",
      ]),
      tuya.whitelabel(
        "Hiking",
  ...
  },
  {
    ...
    extend: [
      tuyaBase({ dp: true }),
      deviceEndpoints({ endpoints: { l1: 1, l2: 1, l3: 1, l4: 1 } }),
    ],
    exposes: [
      tuya.exposes.switch().withEndpoint("l1"),
      tuya.exposes.switch().withEndpoint("l2"),
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .enum("motion_state", ea.STATE, ["none", "small", "medium", "large"])
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Tuya", "BLE-YL01", "Smart WiFi Zigbee chlorine meter", [
        "_TZE200_v1jqz5cy",
      ]),
      tuya.whitelabel(
        "Tuya",
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .binary("valve_state", ea.STATE, false, true)
        .withLabel("Heating in process"),
      e
        .climate()
        .withSystemMode(["off", "heat"], ea.STATE_SET)
        .withPreset(["manual", "auto"])
  ...
  },
  {
    ...
    extend: [
      tuyaBase({ dp: true }),
      deviceEndpoints({ endpoints: { l1: 1, l2: 1, l3: 1 } }),
    ],
    exposes: [
      e.switch().withEndpoint("l1").setAccess("state", ea.STATE_SET),
      e.switch().withEndpoint("l2").setAccess("state", ea.STATE_SET),
    ...
    meta: {
      tuyaDatapoints: [
        ...
        [
          2,
          "preset",
          tuya.valueConverter.thermostatGtz10SystemModeAndPreset("preset"),
        ],
        [
          2,
          "system_mode",
          tuya.valueConverter.thermostatGtz10SystemModeAndPreset("system_mode"),
        ],
        [4, "current_heating_setpoint", tuya.valueConverter.divideBy10],
        [5, "local_temperature", tuya.valueConverter.divideBy10],
        [6, "battery", tuya.valueConverter.raw],
  ...
  },
  {
    ...
    exposes: [
      ...
      e.humidity(),
      e
        .binary("manual_mode", ea.STATE_SET, "Auto", "Manual", "Tempoary")
