...
const definitions: Definition[] = [
    ...
    {
        fingerprint: [{modelID: 'TS0601', manufacturerName: '_TZE200_bcusnqt8'}, {modelID: 'TS0601', manufacturerName: '_TZE204_bcusnqt8'}],
        model: 'SPM01',
        vendor: 'TuYa',
    ...
    },
    {
        ...
        exposes: [tuya.exposes.voltageWithPhase('X'), tuya.exposes.voltageWithPhase('Y'), tuya.exposes.voltageWithPhase('Z'),
            ...
            e.energy().withDescription('Total forward active energy'),
            e.produced_energy().withDescription('Total reverse active energy'),
            e.power_factor().withDescription('Total Power factor'), tuya.exposes.powerWithPhase('total'),
            e.ac_frequency(),
        ],
        meta: {
            tuyaDatapoints: [
                ...
                [15, 'power_factor', tuya.valueConverter.raw],
                [101, 'ac_frequency', tuya.valueConverter.divideBy100],
                [102, 'voltage_X', tuya.valueConverter.divideBy10],
                [103, 'current_X', tuya.valueConverter.divideBy1000],
                [104, 'power_X', tuya.valueConverter.raw],
                [105, 'voltage_Y', tuya.valueConverter.divideBy10],
                [106, 'current_Y', tuya.valueConverter.divideBy1000],
                [107, 'power_Y', tuya.valueConverter.raw],
                [108, 'voltage_Z', tuya.valueConverter.divideBy10],
                [109, 'current_Z', tuya.valueConverter.divideBy1000],
                [110, 'power_Z', tuya.valueConverter.raw],
                [111, 'power_total', tuya.valueConverter.raw],
            ],
        },
    },
    {
