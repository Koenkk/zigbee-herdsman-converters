...
import * as me from '../lib/modernExtend';
...
const definitions: Definition[] = [
    ...
    },
    {
        zigbeeModel: ['\u001aTRADFRI bulb GU10 WW 345lm', 'TRADFRI bulb GU10 WW 345lm', '\\u001TRADFRI bulb GU10 WW 345lm',
            '\u001aTRADFRI bulb GU10 WW 345lm8', 'TRADFRI bulb GU10 WW 380lm'],
        model: 'LED2104R3',
        vendor: 'IKEA',
    ...
    },
    {
        ...
        extend: [me.iasZoneAlarm({zoneType: 'water_leak', zoneAttributes: ['alarm_1', 'battery_low']}), me.battery()],
        ota: ota.tradfri,
    },
];
