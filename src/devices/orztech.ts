...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        toZigbee: [tzLocal.state, tuya.tz.datapoints],
        onEvent: tuya.onEventSetTime,
        configure: tuya.configureMagicPacket,
        exposes: [
            e.switch().withEndpoint('left'),
            e.switch().withEndpoint('right'),
            e.switch().withEndpoint('switch_all'),
            e.switch().withEndpoint('backlight'),
            e.switch().withEndpoint('child_lock'),
            e.switch().withEndpoint('tt_switch'),
        ],
        endpoint: (device) => ({left: 1, right: 1, switch_all: 1, backlight: 1, child_lock: 1, tt_switch: 1}),
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
                [1, 'state_left', tuya.valueConverter.onOff],
                [2, 'state_right', tuya.valueConverter.onOff],
                [13, 'state_switch_all', tuya.valueConverter.onOff],
    ...
    // 3 gang switch
    {
        ...
        endpoint: (device) => ({left: 1, middle: 1, right: 1, switch_all: 1, backlight: 1, child_lock: 1, tt_switch: 1}),
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
                [1, 'state_left', tuya.valueConverter.onOff],
    ...
    // 6 gang switch
    {
        ...
        exposes: [
            ...
            e.switch().withEndpoint('top_middle'),
            e.switch().withEndpoint('top_right'),
            e.switch().withEndpoint('bottom_left'),
            e.switch().withEndpoint('bottom_middle'),
        ...
        endpoint: (device) => ({top_left: 1, top_middle: 1, top_right: 1, bottom_left: 1, bottom_middle: 1, bottom_right: 1, switch_all: 1, backlight: 1, child_lock: 1, tt_switch: 1}),
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
