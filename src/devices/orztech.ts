...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        extend: [tuya.modernExtend.tuyaBase({dp: true})],
        exposes: [
            e.switch().withEndpoint("left").withDescription("Left"),
            e.switch().withEndpoint("right").withDescription("Right"),
            e.switch().withEndpoint("all").withDescription("Switch all"),
            e.switch().withEndpoint("backlight").withDescription("Backlight"),
            e.switch().withEndpoint("child_lock").withDescription("Child lock"),
            e.switch().withEndpoint("tt_switch").withDescription("TT switch"),
        ],
        endpoint: (device) => ({left: 1, right: 1, all: 1, backlight: 1, child_lock: 1, tt_switch: 1}),
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
                [1, "state_left", tuya.valueConverter.onOff],
                [2, "state_right", tuya.valueConverter.onOff],
                [13, "state_all", tuya.valueConverter.onOff],
                [16, "state_backlight", tuya.valueConverter.onOff],
                [101, "state_child_lock", tuya.valueConverter.onOff],
                [102, "state_tt_switch", tuya.valueConverter.onOff],
            ],
        },
    },
    {
        fingerprint: tuya.fingerprint("TS0601", ["_TZE284_pcg0rykt"]),
        model: "_TZE284_pcg0rykt",
        vendor: "Orztech",
        description: "3 gang touch wall switch",
        extend: [tuya.modernExtend.tuyaBase({dp: true})],
        exposes: [
            e.switch().withEndpoint("left").withDescription("Left"),
            e.switch().withEndpoint("middle").withDescription("Middle"),
            e.switch().withEndpoint("right").withDescription("Right"),
            e.switch().withEndpoint("all").withDescription("Switch all"),
            e.switch().withEndpoint("backlight").withDescription("Backlight"),
            e.switch().withEndpoint("child_lock").withDescription("Child lock"),
        ...
        endpoint: (device) => ({left: 1, middle: 1, right: 1, all: 1, backlight: 1, child_lock: 1, tt_switch: 1}),
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
                [1, "state_left", tuya.valueConverter.onOff],
                [2, "state_middle", tuya.valueConverter.onOff],
                [3, "state_right", tuya.valueConverter.onOff],
                [13, "state_all", tuya.valueConverter.onOff],
                [16, "state_backlight", tuya.valueConverter.onOff],
                [101, "state_child_lock", tuya.valueConverter.onOff],
                [102, "state_tt_switch", tuya.valueConverter.onOff],
    ...
    {
        fingerprint: tuya.fingerprint("TS0601", ["_TZE284_xo3vpoah"]),
        model: "_TZE284_xo3vpoah",
        vendor: "Orztech",
        description: "6 gang touch wall switch",
        extend: [tuya.modernExtend.tuyaBase({dp: true})],
        exposes: [
            e.switch().withEndpoint("top_left").withDescription("Top Left"),
            e.switch().withEndpoint("top_middle").withDescription("Top Middle"),
            e.switch().withEndpoint("top_right").withDescription("Top Right"),
            e.switch().withEndpoint("bottom_left").withDescription("Bottom Left"),
            e.switch().withEndpoint("bottom_middle").withDescription("Bottom Middle"),
            e.switch().withEndpoint("bottom_right").withDescription("Bottom Right"),
            e.switch().withEndpoint("all").withDescription("Switch all"),
            e.switch().withEndpoint("backlight").withDescription("Backlight"),
            e.switch().withEndpoint("child_lock").withDescription("Child lock"),
            e.switch().withEndpoint("tt_switch").withDescription("TT switch"),
        ...
        meta: {
            multiEndpoint: true,
            tuyaDatapoints: [
                [1, "state_top_left", tuya.valueConverter.onOff],
                [2, "state_top_middle", tuya.valueConverter.onOff],
                [3, "state_top_right", tuya.valueConverter.onOff],
                [4, "state_bottom_left", tuya.valueConverter.onOff],
                [5, "state_bottom_middle", tuya.valueConverter.onOff],
                [6, "state_bottom_right", tuya.valueConverter.onOff],
                [13, "state_all", tuya.valueConverter.onOff],
                [16, "state_backlight", tuya.valueConverter.onOff],
                [101, "state_child_lock", tuya.valueConverter.onOff],
                [102, "state_tt_switch", tuya.valueConverter.onOff],
