...
const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        fingerprint: [{ modelID: 'Dimmer-Switch-ZB3.0', manufacturerName: 'Candeo' }, { modelID: 'HK_DIM_A', manufacturerName: 'Shyugj' }],
        model: 'C202.1',
        vendor: 'Candeo',
    ...
    {
        zigbeeModel: ['C202'],
        fingerprint: [{ modelID: 'C202', manufacturerName: 'Candeo' }, { modelID: 'Candeo Zigbee Dimmer', softwareBuildID: '1.04', dateCode: '20230828' }, { modelID: 'Candeo Zigbee Dimmer', softwareBuildID: '1.20', dateCode: '20240813' }],
        model: 'C202',
        vendor: 'Candeo',
