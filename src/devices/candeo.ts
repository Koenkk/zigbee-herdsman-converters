...
const kineticRFButtonMultiPressOptions = {
    actions: () =>
        e
            .enum("actions", ea.SET, ["single", "single & double", "single, double & triple", "single, double, triple & quadruple", "single, double, triple, quadruple & quintuple"])
    ...
    kinetic_rf_button_multi_press: {
        ...
        convert: (model, msg, publish, options, meta) => {
            if (utils.hasAlreadyProcessedMessage(msg, model)) return;
                ...
                let button_click_count = globalStore.getValue(endpoint, "button_click_count") as number | undefined;
                button_click_count = button_click_count ? button_click_count + 1 : 1;
                globalStore.putValue(endpoint, "button_click_count", button_click_count);
...
export const definitions: DefinitionWithExtend[] = [
    ...
    {     
        ...
        fromZigbee: [
            fzLocal.kinetic_rf_button_multi_press,
        ],
        toZigbee: [],
        exposes: [
