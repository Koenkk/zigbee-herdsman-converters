...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        extend: [philips.m.addManuSpecificPhilips2Cluster(), philips.m.light({colorTemp: {range: [153, 454]}})],
    },
    {
        zigbeeModel: ["LCU001"],
        model: "8719514491229",
        ...
        extend: [philips.m.addManuSpecificPhilips2Cluster(), philips.m.light({colorTemp: {range: [153, 500]}, color: true})],
    },
    {
        zigbeeModel: ["LTV006"],
        model: "929003596101",
        ...
        extend: [philips.m.addManuSpecificPhilips2Cluster(), philips.m.light({colorTemp: {range: [222, 454]}})],
    },
    {
        zigbeeModel: ["SOC001"],
        model: "9290035639",
