...
export const definitions: DefinitionWithExtend[] = [
    ...
    {
        zigbeeModel: ["929004611501_01"],
        model: "929004611501_01",
        vendor: "Philips",
        description: "Hue white ambiance bathroom ceiling light Adore with Bluetooth 3-pack",
        extend: [philips.m.light({colorTemp: {range: [153, 454]}})],
    },
    {
        zigbeeModel: ["929004611501_02"],
        model: "929004611501_02",
        vendor: "Philips",
        description: "Hue white ambiance bathroom ceiling light Adore with Bluetooth 3-pack",
        extend: [philips.m.light({colorTemp: {range: [153, 454]}})],
    },
