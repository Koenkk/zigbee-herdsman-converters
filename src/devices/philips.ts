...
export const definitions: DefinitionWithExtend[] = [
    {
        zigbeeModel: ["929004297501"],
        model: "929004297501",
        vendor: "Signify Netherlands B.V.",
        description: "Hue Devote ceiling light M",
        extend: [philips.m.light({colorTemp: {range: [153, 500]}, color: {modes: ["xy", "hs"], enhancedHue: true}})],
        meta: {}, // Needed? This was in the autogenerated definition but not sure if this is necessary
    },
    {
        zigbeeModel: ["LCA010"],
        model: "LCA010",
        vendor: "Signify Netherlands B.V.",
        description: "Hue White and Color Ambiance A60 - E27 smart bulb (810lm)",
