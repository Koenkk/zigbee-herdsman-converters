...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        whiteLabel: [
            {model: "929003598001", vendor: "Philips", description: "Hue White and Color Ambiance Surimu square panel 30x30 cm", fingerprint: [{modelID: "929003598001"}]},
            {model: "929003598002", vendor: "Philips", description: "Hue White and Color Ambiance Surimu square panel 30x30 cm", fingerprint: [{modelID: "929003598002"}]},
            {model: "929002966401", vendor: "Philips", description: "Hue White and Color Ambiance Surimu square panel 60x60 cm", fingerprint: [{modelID: "929002966401"}]},
            {model: "929002966402", vendor: "Philips", description: "Hue White and Color Ambiance Surimu sqaure panel 60x60 cm", fingerprint: [{modelID: "929002966402"}]},
            {model: "929002966502", vendor: "Philips", description: "Hue White and Color Ambiance Surimu rectangle panel 30x120 cm", fingerprint: [{modelID: "929002966502"}]},
            {model: "929003598101", vendor: "Philips", description: "Hue White and Color Ambiance Surimu round panel", fingerprint: [{modelID: "929003598101"}]},
            {model: "929003598102", vendor: "Philips", description: "Hue White and Color Ambiance Surimu round panel", fingerprint: [{modelID: "929003598102"}]},
        ],
        extend: [philips.m.light({colorTemp: {range: [153, 500]}, color: true})],
    },
    {
