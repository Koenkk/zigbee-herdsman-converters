...
export const definitions: DefinitionWithExtend[] = [
    ...
    {
    zigbeeModel: ['929003808501_01'],
    model: '929003808501_01',
    vendor: 'Signify Netherlands B.V.',
    description: 'Centris Hue 2-spot white special form V2 linear light',
    extend: [philips.m.light({"colorTemp":{"range":[153,500]},"color":{"modes":["xy","hs"],"enhancedHue":true}})],
    meta: {},
    },
    {
    zigbeeModel: ['929003808501_02'],
    model: '929003808501_02',
    vendor: 'Signify Netherlands B.V.',
    description: 'Centris Hue 2-spot white special form V2 Center Spot',
    extend: [philips.m.light({"colorTemp":{"range":[153,500]},"color":{"modes":["xy","hs"],"enhancedHue":true}})],
    meta: {},
    },
    {
    zigbeeModel: ['929003808501_03'],
    model: '929003808501_03',
    vendor: 'Signify Netherlands B.V.',
    description: 'Centris Hue 2-spot white special form V2 Outer Spot',
    extend: [philips.m.light({"colorTemp":{"range":[153,500]},"color":{"modes":["xy","hs"],"enhancedHue":true}})],
    meta: {},
    },
    {
