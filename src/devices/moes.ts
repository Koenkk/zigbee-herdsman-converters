...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        exposes: (device, options) => {
            return [
                ...
                e.numeric('brightness_1', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 1 brightness'),
                e.numeric('brightness_min_1', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 1 minimum brightness'),
                e.numeric('brightness_max_1', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 1 maximum brightness'),
                e.numeric('countdown_1', ea.STATE_SET)
                    .withValueMin(0).withValueMax(86400).withValueStep(1)
                    .withUnit('s').withDescription('Channel 1 countdown'),
                e.enum('relay_status', ea.STATE_SET, ['off', 'on', 'memory'])
                    .withDescription('Relay mode after power restoration'),
                e.enum('light_mode', ea.STATE_SET, ['none', 'relay', 'pos'])
                    .withDescription('Indicator light mode'),
                e.binary('switch_backlight', ea.STATE_SET, 'ON', 'OFF')
        ...
        meta: {
            ...
            tuyaDatapoints: [
                ...
                [21, 'light_mode', tuya.valueConverterBasic.lookup({
                    'none': tuya.enum(0),
                    'relay': tuya.enum(1),
                    'pos': tuya.enum(2)
                })],
    ...
    },
    {
        ...
        exposes: (device, options) => {
            return [
                ...
                e.numeric('brightness_2', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 2 brightness'),
                e.numeric('brightness_min_2', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 2 minimum brightness'),
                e.numeric('brightness_max_2', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 2 maximum brightness'),
                e.numeric('countdown_2', ea.STATE_SET)
                    .withValueMin(0).withValueMax(86400).withValueStep(1)
                    .withUnit('s').withDescription('Channel 2 countdown'),
                e.enum('relay_status', ea.STATE_SET, ['off', 'on', 'memory'])
                    .withDescription('Relay mode after power restoration'),
                e.enum('light_mode', ea.STATE_SET, ['none', 'relay', 'pos'])
                    .withDescription('Indicator light mode'),
    ...
    },
    {
        ...
        exposes: (device, options) => {
            return [
                ...
                e.enum('relay_status', ea.STATE_SET, ['off', 'on', 'memory'])
                    .withDescription('Relay mode after power restoration'),
                e.numeric('brightness_3', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 3 brightness'),
                e.numeric('brightness_min_3', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 3 minimum brightness'),
                e.numeric('brightness_max_3', ea.STATE_SET)
                    .withValueMin(10).withValueMax(1000).withValueStep(1)
                    .withDescription('Channel 3 maximum brightness'),
                e.numeric('countdown_3', ea.STATE_SET)
                    .withValueMin(0).withValueMax(86400).withValueStep(1)
                    .withUnit('s').withDescription('Channel 3 countdown'),
                e.enum('light_mode', ea.STATE_SET, ['none', 'relay', 'pos'])
                    .withDescription('Indicator light mode'),
                e.binary('switch_backlight', ea.STATE_SET, 'ON', 'OFF')
                    .withDescription('Backlight switch')
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("momentary_1", ea.STATE_SET)
                .withValueMin(0)
                .withValueMax(3600)
                .withValueStep(1)
                .withUnit("s")
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("momentary_1", ea.STATE_SET)
                ...
                .withUnit("s")
                .withDescription("Momentary switch timer (0=disable)"),
            e.numeric("momentary_2", ea.STATE_SET)
                .withValueMin(0)
                .withValueMax(3600)
                .withValueStep(1)
                .withUnit("s")
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("momentary_2", ea.STATE_SET)
                ...
                .withUnit("s")
                .withDescription("Momentary switch timer (0=disable)"),
            e.numeric("momentary_3", ea.STATE_SET)
                .withValueMin(0)
                .withValueMax(3600)
                .withValueStep(1)
                .withUnit("s")
    ...
    },
    {
        ...
        exposes: [
            ...
            e.numeric("momentary_3", ea.STATE_SET)
                ...
                .withUnit("s")
                .withDescription("Momentary switch timer (0=disable)"),
            e.numeric("momentary_4", ea.STATE_SET)
                .withValueMin(0)
                .withValueMax(3600)
                .withValueStep(1)
                .withUnit("s")
