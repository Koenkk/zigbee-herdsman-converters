...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        exposes: (device, options) => {
            ...
            const weeklyProgramExpose = e.composite('weekly_programming', 'weekly_programming', ea.STATE_SET)
            ...
            return [
                ...
                // Valve state
                e.binary('valve_state', ea.STATE, 'OPEN', 'CLOSED')
                    .withDescription('Valve state'),

                // Sensor selection
                e.enum('sensor', ea.STATE_SET, ['internal', 'external', 'both'])
                ...
                e.enum('backlight_brightness', ea.STATE_SET, ['0', '20', '50', '100'])
                ...
                e.numeric('min_temperature_limit', ea.STATE_SET)
                    .withValueMin(5).withValueMax(20).withValueStep(1)
                    .withUnit('°C')
                    .withDescription('Minimum temperature limit'),
                e.numeric('max_temperature_limit', ea.STATE_SET)
                    .withValueMin(30).withValueMax(70).withValueStep(1)
                    .withUnit('°C')
                ...
                e.numeric('deadzone_temperature', ea.STATE_SET)
                    .withUnit('°C')
                    .withValueMin(0.5).withValueMax(3.0).withValueStep(0.5)
                    .withDescription('Temperature hysteresis/deadzone'),
                    
                // ECO mode temperature
                e.numeric('eco_temperature', ea.STATE_SET)
                    .withUnit('°C')
                    .withValueMin(5).withValueMax(35).withValueStep(1)
                    .withDescription('ECO mode temperature setting'),

                // Program mode
                e.enum('program_mode', ea.STATE_SET, ['off', 'weekend', 'single_break', 'no_day_off'])
        ...
        meta: {
            tuyaDatapoints: [
                ...
                // Backlight - FIXED: Using numeric strings to match expose definition
                ...
                // Temperature calibration (using specialized converter)
                ...
                // Running state and valve state (same DP, different mappings)
                ...
                // Main control sensor: Air/Internal (DP 117)
                [117, 'local_temperature', tuya.valueConverter.divideBy10],
                
                // Secondary sensor: Floor (DP 101)
                ...
                // *** WEEKLY SCHEDULE - FULLY WORKING (at the end) ***
