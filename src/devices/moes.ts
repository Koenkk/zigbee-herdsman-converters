...
const exposesLocal = {
  ...
  minute: (name: string) =>
    e
      ...
      .withValueMin(0)
      .withValueMax(59),
  program_temperature: (name: string) =>
    e
      .numeric(name, ea.STATE_SET)
      .withUnit("°C")
      .withValueMin(5)
...
export const definitions: DefinitionWithExtend[] = [
  {
    ...
    exposes: [
      ...
      e
        .binary("window", ea.STATE, "OPENED", "CLOSED")
  ...
  {
    fingerprint: [
      ...tuya.fingerprint("TS0121", ["_TYZB01_iuepbmpv"]),
      ...tuya.fingerprint("TS011F", ["_TZ3000_zmy1waw6", "_TZ3000_bkfe0bab"]),
    ],
    model: "MS-104Z",
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("KnockautX", "FMS2C017", "2 gang switch", [
        "_TZ3000_iv6ph5tr",
      ]),
    ],
  },
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Moes", "BHT-002/BHT-006", "Smart heating thermostat", [
        "_TZE204_aoclfnxz",
      ]),
    ],
    exposes: (device, options) => {
      const heatingStepSize =
        device?.manufacturerName === "_TZE204_5toc8efa" ? 0.5 : 1;
      const runningStates =
      ...
      return [
        ...
        e
          ...
          .withFeature(
            exposesLocal.program_temperature("sunday_p3_temperature"),
          )
          .withFeature(exposesLocal.hour("sunday_p4_hour"))
          .withFeature(exposesLocal.minute("sunday_p4_minute"))
          .withFeature(
            exposesLocal.program_temperature("sunday_p4_temperature"),
          ),
      ];
    },
    ...
    exposes: [
      ...
      e
        .enum(
          "indicate_light",
          ea.STATE_SET,
          Object.values(legacy.moesSwitch.indicateLight),
        )
      ...
      e
        .enum(
          "power_on_behavior",
          ea.STATE_SET,
          Object.values(legacy.moesSwitch.powerOnBehavior),
        )
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      legacy.fz.tuya_switch,
      legacy.fz.moes_switch,
    ],
    toZigbee: [legacy.tz.tuya_switch_state, legacy.tz.moes_switch],
    onEvent: tuya.onEventSetLocalTime,
    meta: { multiEndpoint: true },
  ...
  },
  {
    ...
    exposes: [
      ...
      e.window_detection(),
      e
        .binary("window", ea.STATE, "OPEN", "CLOSED")
        .withDescription("Window status closed or open "),
      e
        .climate()
        .withLocalTemperature(ea.STATE)
      ...
      e
        .numeric("boost_heating_countdown", ea.STATE)
        .withUnit("min")
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("Tuya", "iH-F8260", "Universal smart IR remote control", [
        "_TZ3290_gnl5a6a5xvql7c2a",
      ]),
    ],
  },
  {
    fingerprint: tuya.fingerprint("TS0049", [
      "_TZ3000_cjfmu5he",
      "_TZ3000_kz1anoi8",
      "_TZ3000_mq4wujmp",
    ]),
  ...
  },
  {
    ...
    whiteLabel: [
      tuya.whitelabel("HEIMAN", "HS-720ES", "Carbon monoxide alarm", [
        "_TZE200_hr0tdd47",
      ]),
    ],
  },
    ...
    meta: {
      tuyaDatapoints: [
        ...
        [
          32,
          "sensor_mode",
          tuya.valueConverterBasic.lookup({ IN: 0, AL: 1, OU: 2 }),
        ],
        ...
        [
          101,
          "local_temperature_calibration",
          tuya.valueConverter.localTemperatureCalibration_256,
        ],
  ...
  },
  {
    ...
    exposes: [
      e.cover_position(),
      e
        .binary("charging", ea.STATE, true, false)
        .withDescription("Whether the device is being charged via USB-C"),
      e
      ...
      e
        .enum("button_position", ea.STATE_SET, ["UP", "DOWN"])
        .withDescription("Swaps the behavior of the device's physical buttons"),
    ],
    meta: {
      ...
      tuyaDatapoints: [
        ...
        [
          106,
          "automatic_mode",
          tuya.valueConverterBasic.lookup({ ON: 1, OFF: 0 }),
        ],
