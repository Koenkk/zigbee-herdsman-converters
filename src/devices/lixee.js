    ...
    lixee_ha_electrical_measurement: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            const elements = [
                ...
                /* 0x0305 */ 'ReactivePowerQ1',
                /* 0x050E */ 'reactivePowerQ2',
                /* 0x090E */ 'reactivePowerQ3',
                /* 0x0A0E */ 'reactivePowerQ4',
...
const allPhaseData = [
    ...
    {cluster: clustersDef._0x0B04, att: 'activePowerN1', reportable: true, onlyProducer: false, exposes: exposes.numeric('CCASN-1', ea.STATE).withUnit('W').withProperty('active_power_n_1').withDescription('Previous point of the active load curve drawn')},
    ...
    {cluster: clustersDef._0x0B04, att: 'ReactivePowerQ1', reportable: true, onlyProducer: true, exposes: exposes.numeric('ERQ1', ea.STATE).withUnit('VArh').withProperty('reactive_power_q_1').withDescription('Total reactive power (Q1)')},
    {cluster: clustersDef._0x0B04, att: 'reactivePowerQ2', reportable: true, onlyProducer: true, exposes: exposes.numeric('ERQ2', ea.STATE).withUnit('VArh').withProperty('reactive_power_q_2').withDescription('Total reactive power (Q2)')},
    {cluster: clustersDef._0x0B04, att: 'reactivePowerQ3', reportable: true, onlyProducer: true, exposes: exposes.numeric('ERQ3', ea.STATE).withUnit('VArh').withProperty('reactive_power_q_3').withDescription('Total reactive power (Q3)')},
    {cluster: clustersDef._0x0B04, att: 'reactivePowerQ4', reportable: true, onlyProducer: true, exposes: exposes.numeric('ERQ4', ea.STATE).withUnit('VArh').withProperty('reactive_power_q_4').withDescription('Total reactive power (Q4)')},
...
const legacyData = [
    ...
    {linkyPhase: linkyPhaseDef.all, cluster: clustersDef._0xFF66, att: 'motDetat', reportable: false, onlyProducer: false, exposes: exposes.text('MOTDETAT', ea.STATE).withProperty('mot_detat').withDescription('Meter Status Word')},
