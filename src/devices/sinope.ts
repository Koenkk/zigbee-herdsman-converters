        ...
        fromZigbee: [
            fz.fan,
            {
                ...
                convert: (model, msg, publish, options, meta) => {
                    ...
                    if (result) {
                        const heatingSetpoint = result.occupied_heating_setpoint;
                        ...
                        // Synchronize setpoints for a consistent UI experience
                        const val = heatingSetpoint || coolingSetpoint;
                        if (val !== undefined) {
                            result.occupied_heating_setpoint = val;
                            result.occupied_cooling_setpoint = val;
                        }
                    }
                    return result;
                },
