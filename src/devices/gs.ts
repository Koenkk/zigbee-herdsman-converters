...
const definitions: DefinitionWithExtend[] = [
    {
        ...
        extend: [light({colorTemp: {range: undefined}, color: true}), identify()],
    },
    {
        ...
        extend: [light({colorTemp: {range: [153, 370]}}), identify()],
    },
    {
    ...
    },
    {
        ...
        extend: [onOff({powerOnBehavior: false}), electricityMeter(), identify()],
    },
    {
        zigbeeModel: ['SMHM-I1'],
        model: 'SMHM-I1',
    ...
    },
    {
        ...
        extend: [iasZoneAlarm({zoneType: 'contact', zoneAttributes: ['alarm_1', 'tamper', 'battery_low']}), battery({voltage: true})],
    },
    {
        ...
        extend: [ignoreClusterReport({cluster: 'genBasic'}), iasWarning(), battery()],
    },
    {
        zigbeeModel: ['SSHM-I1'],
        model: 'SSHM-I1',
        ...
        extend: [iasZoneAlarm({zoneType: 'smoke', zoneAttributes: ['alarm_1', 'tamper', 'battery_low']}), battery()],
    },
    {
    ...
    },
    {
        ...
        extend: [iasZoneAlarm({zoneType: 'water_leak', zoneAttributes: ['alarm_1', 'tamper', 'battery_low']}), battery({voltage: true})],
    },
];
