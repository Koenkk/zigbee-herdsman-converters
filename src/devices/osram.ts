...
import {ledvanceExtend, ledvanceFz, ledvanceLight, ledvanceOnOff} from "../lib/ledvance";
...
export const definitions: DefinitionWithExtend[] = [
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({color: true})],
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: undefined}, color: true})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: undefined}})],
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [153, 370]}})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [153, 526]}, color: true})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [153, 526]}, color: {modes: ["hs"]}})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [150, 370]}})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [125, 666]}, color: {modes: ["xy", "hs"]}})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: undefined}, color: {modes: ["xy", "hs"]}})],
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [153, 370]}, color: {modes: ["hs"]}})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({colorTemp: {range: [125, 666]}, color: true})],
    },
    {
    ...
    },
    {
        ...
        extend: [ledvanceExtend.addmanuSpecificOsramCluster(), ledvanceLight({configureReporting: true, ota: true})],
        onEvent: (event) => {
    ...
    },
    {
        ...
        extend: [
            ledvanceExtend.addmanuSpecificOsramCluster(),
            m.deviceEndpoints({endpoints: {l1: 10, l2: 11}}),
            ledvanceLight({configureReporting: true, endpointNames: ["l1", "l2"], ota: true}),
        ],
    },
    {
        fingerprint: [
