...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        extend: [
            modernExtend.switch({powerOnBehavior: false}),
            modernExtend.electricalMeasurements({current: {divisor: 1000}, voltage: {divisor: 1}, power: {divisor: 1}, energy: {divisor: 100}}),
        ],
    },
    {
        zigbeeModel: ['SP 110'],
