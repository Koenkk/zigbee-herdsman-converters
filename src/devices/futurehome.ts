...
const definitions: Definition[] = [
    {
        fingerprint: tuya.fingerprint('TS0601', ['_TZE204_e5hpkc6d']),
        ...
        exposes: [
            ...
            e.enum('temperature_sensor', ea.STATE, ['air_sensor', 'floor_sensor', 'max_guard'])
                .withDescription(
            ...
            e.numeric('local_temperature_floor', ea.STATE).withUnit('°C').withDescription('Floor temperature'),
        ],
        meta: {
            tuyaDatapoints: [
                ...
                [102, 'temperature_sensor', tuya.valueConverterBasic.lookup(
