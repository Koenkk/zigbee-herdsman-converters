...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        exposes: [e.battery(),
          e.enum('l3', ea.STATE_SET).withDescription('Counter value. Write zero or positive value to set a counter value. Write a negative value to set a wakeup interval in minutes'),
          e.enum('l5', ea.STATE_SET).withDescription('Counter value. Write zero or positive value to set a counter value. Write a negative value to set a wakeup interval in minutes'),
