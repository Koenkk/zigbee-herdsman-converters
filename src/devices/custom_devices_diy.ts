    ...
    },
    {
        ...
        extend: [
            ...
            numeric({
                ...
                attribute: {ID: 0x0010, type: Zcl.Zcl.DataType.INT16},
                valueMin: -100.0,
                valueMax: 100.0,
                valueStep: 0.01,
                scale: 100,
            ...
            numeric({
                ...
                unit: '°C',
                cluster: 'hvacUserInterfaceCfg',
                attribute: {ID: 0x0102, type: Zcl.Zcl.DataType.INT16},
                valueMin: -100.0,
                valueMax: 100.0,
                scale: 100,
            ...
            numeric({
                ...
                unit: '°C',
                cluster: 'hvacUserInterfaceCfg',
                attribute: {ID: 0x0103, type: Zcl.Zcl.DataType.INT16},
                valueMin: -100.0,
                valueMax: 100.0,
                scale: 100,
            ...
            numeric({
                ...
                unit: '%',
                cluster: 'hvacUserInterfaceCfg',
                attribute: {ID: 0x0104, type: Zcl.Zcl.DataType.UINT16},
                valueMin: 0.0,
                valueMax: 100.0,
                scale: 100,
            ...
            numeric({
                ...
                unit: '%',
                cluster: 'hvacUserInterfaceCfg',
                attribute: {ID: 0x0105, type: Zcl.Zcl.DataType.UINT16},
                valueMin: 0.0,
                valueMax: 100.0,
                scale: 100,
