...
const definitions: Definition[] = [
    ...
    },
    {
        ...
        exposes: [e.battery(),
          e.numeric('l3', ea.STATE_SET).withDescription('Counter value. Write zero or positive value to set a counter value. Write a negative value to set a wakeup interval in minutes'),
          e.numeric('l5', ea.STATE_SET).withDescription('Counter value. Write zero or positive value to set a counter value. Write a negative value to set a wakeup interval in minutes'),
