...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        extend: [m.deviceEndpoints({endpoints: {top: 16, center: 17, bottom: 18}}), m.onOff({endpointNames: ["top", "center", "bottom"]})],
    },
    {
        ...
        description: "Smart light switch - 4 gang v2.0",
        extend: [
            m.deviceEndpoints({endpoints: {top_left: 16, top_right: 17, bottom_right: 18, bottom_left: 19}}),
            m.onOff({endpointNames: ["top_left", "top_right", "bottom_right", "bottom_left"]}),
        ],
    },
    {
    ...
    },
    {
        ...
        extend: [m.deviceEndpoints({endpoints: {top: 11, bottom: 12}}), m.onOff({endpointNames: ["top", "bottom"], configureReporting: false})],
    ...
    },
    {
        ...
        extend: [m.deviceEndpoints({endpoints: {left: 11, right: 12}}), m.onOff({endpointNames: ["left", "right"]})],
    },
    {
    ...
    },
    {
        ...
        extend: [
            m.deviceEndpoints({endpoints: {button_light: 1, button_fan_high: 2, button_fan_med: 3, button_fan_low: 4}}),
            m.onOff({endpointNames: ["button_light", "button_fan_high", "button_fan_med", "button_fan_low"]}),
