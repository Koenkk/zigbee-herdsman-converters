...
const converters = {
    ...
    moes_thermostat_program_schedule: {
        ...
        convertSet: async (entity, key, value, meta) => {
            ...
            const payload = [
                Math.floor(newState.weekdays_p1_hour),
                Math.floor(newState.weekdays_p1_minute),
                Math.round(newState.weekdays_p1_temperature * 2),
                Math.floor(newState.weekdays_p2_hour),
                Math.floor(newState.weekdays_p2_minute),
                Math.round(newState.weekdays_p2_temperature * 2),
                Math.floor(newState.weekdays_p3_hour),
                Math.floor(newState.weekdays_p3_minute),
                Math.round(newState.weekdays_p3_temperature * 2),
                Math.floor(newState.weekdays_p4_hour),
                Math.floor(newState.weekdays_p4_minute),
                Math.round(newState.weekdays_p4_temperature * 2),
                Math.floor(newState.saturday_p1_hour),
                Math.floor(newState.saturday_p1_minute),
                Math.round(newState.saturday_p1_temperature * 2),
                Math.floor(newState.saturday_p2_hour),
                Math.floor(newState.saturday_p2_minute),
                Math.round(newState.saturday_p2_temperature * 2),
                Math.floor(newState.saturday_p3_hour),
                Math.floor(newState.saturday_p3_minute),
                Math.round(newState.saturday_p3_temperature * 2),
                Math.floor(newState.saturday_p4_hour),
                Math.floor(newState.saturday_p4_minute),
                Math.round(newState.saturday_p4_temperature * 2),
                Math.floor(newState.sunday_p1_hour),
                Math.floor(newState.sunday_p1_minute),
                Math.round(newState.sunday_p1_temperature * 2),
                Math.floor(newState.sunday_p2_hour),
                Math.floor(newState.sunday_p2_minute),
                Math.round(newState.sunday_p2_temperature * 2),
                Math.floor(newState.sunday_p3_hour),
                Math.floor(newState.sunday_p3_minute),
                Math.round(newState.sunday_p3_temperature * 2),
                Math.floor(newState.sunday_p4_hour),
                Math.floor(newState.sunday_p4_minute),
                Math.round(newState.sunday_p4_temperature * 2),
            ];
