...
const converters = {
    ...
    moes_thermostat_program_schedule: {
        key: [
            'weekdays_p1_hour', 'weekdays_p1_minute', 'weekdays_p1_temperature',
            'weekdays_p2_hour', 'weekdays_p2_minute', 'weekdays_p2_temperature',
            'weekdays_p3_hour', 'weekdays_p3_minute', 'weekdays_p3_temperature',
            'weekdays_p4_hour', 'weekdays_p4_minute', 'weekdays_p4_temperature',
            'saturday_p1_hour', 'saturday_p1_minute', 'saturday_p1_temperature',
            'saturday_p2_hour', 'saturday_p2_minute', 'saturday_p2_temperature',
            'saturday_p3_hour', 'saturday_p3_minute', 'saturday_p3_temperature',
            'saturday_p4_hour', 'saturday_p4_minute', 'saturday_p4_temperature',
            'sunday_p1_hour', 'sunday_p1_minute', 'sunday_p1_temperature',
            'sunday_p2_hour', 'sunday_p2_minute', 'sunday_p2_temperature',
            'sunday_p3_hour', 'sunday_p3_minute', 'sunday_p3_temperature',
            'sunday_p4_hour', 'sunday_p4_minute', 'sunday_p4_temperature',
        ],
        convertSet: async (entity, key, value, meta) => {
            ...
            const payload = [
                Math.floor(newState.weekdays_p1_hour), Math.floor(newState.weekdays_p1_minute), Math.round(newState.weekdays_p1_temperature * 2),
                Math.floor(newState.weekdays_p2_hour), Math.floor(newState.weekdays_p2_minute), Math.round(newState.weekdays_p2_temperature * 2),
                Math.floor(newState.weekdays_p3_hour), Math.floor(newState.weekdays_p3_minute), Math.round(newState.weekdays_p3_temperature * 2),
                Math.floor(newState.weekdays_p4_hour), Math.floor(newState.weekdays_p4_minute), Math.round(newState.weekdays_p4_temperature * 2),
                Math.floor(newState.saturday_p1_hour), Math.floor(newState.saturday_p1_minute), Math.round(newState.saturday_p1_temperature * 2),
                Math.floor(newState.saturday_p2_hour), Math.floor(newState.saturday_p2_minute), Math.round(newState.saturday_p2_temperature * 2),
                Math.floor(newState.saturday_p3_hour), Math.floor(newState.saturday_p3_minute), Math.round(newState.saturday_p3_temperature * 2),
                Math.floor(newState.saturday_p4_hour), Math.floor(newState.saturday_p4_minute), Math.round(newState.saturday_p4_temperature * 2),
                Math.floor(newState.sunday_p1_hour), Math.floor(newState.sunday_p1_minute), Math.round(newState.sunday_p1_temperature * 2),
                Math.floor(newState.sunday_p2_hour), Math.floor(newState.sunday_p2_minute), Math.round(newState.sunday_p2_temperature * 2),
                Math.floor(newState.sunday_p3_hour), Math.floor(newState.sunday_p3_minute), Math.round(newState.sunday_p3_temperature * 2),
                Math.floor(newState.sunday_p4_hour), Math.floor(newState.sunday_p4_minute), Math.round(newState.sunday_p4_temperature * 2),
            ];
