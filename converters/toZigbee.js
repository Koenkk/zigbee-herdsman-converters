    ...
    ZNCJMB14LM: {
        ...
        convertSet: async (entity, key, value, meta) => {
            if (key === 'theme') {
                ...
                await entity.write('aqaraOpple', {0x0217: {value: lookup[value], type: 0x20}}, {manufacturerCode: 0x115f});
                return {state: {font_size: value}};
            } else if (key === 'lcd_auto_brightness_enabled') {
                await entity.write('aqaraOpple', {0x0218: {value: value, type: 0x10}}, {manufacturerCode: 0x115f});
                return {state: {lcd_auto_brightness_enabled: value}};
            } else if (key === 'homepage') {
                const lookup = {'scene': 0, 'feel': 1, 'thermostat': 2, 'switch': 3};
                await entity.write('aqaraOpple', {0x0219: {value: lookup[value], type: 0x20}}, {manufacturerCode: 0x115f});
                return {state: {homepage: value}};
            } else if (key === 'screen_saver_enabled') {
                await entity.write('aqaraOpple', {0x0221: {value: value, type: 0x10}}, {manufacturerCode: 0x115f});
