...
const numericAttributes2Payload = (msg, meta, model, options, dataObject) => {
    ...
    Object.entries(dataObject).forEach(([key, value]) => {
        ...
        case '4':
            ...
            break;
        case '5':
            if (['WSDCGQ11LM'].includes(model.model)) {
                // Ingore this value for WSDCGQ11LM as it doesn't make sense for the device
                // it also does not seem to reflect what is usualy in power_outage_count, as the value
                // does not increase when the power is removed and restored.
            } else {
                payload.power_outage_count = value - 1;
            }
            break;
