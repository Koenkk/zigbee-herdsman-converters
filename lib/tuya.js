...
const dataPoints = {
    ...
    alecto_Smoke_state: 1,
    alecto_Smoke_value: 2,
    alecto_Self_checking: 8,
    alecto_Checking_result: 9,
    alecto_Smoke_test: 11,
    alecto_Lifecycle: 12,
    alecto_Battery_state: 14,
    alecto_Battery_percentage: 15,
    alecto_Silence: 16,
};
