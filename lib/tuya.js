...
const tuyaExposes = {
    ...
    gasState: () => exposes.enum('gas_state', ea.STATE, ['alarm', 'normal']).withDescription('Gas detection state'),
    gasValue: () => exposes.numeric('gas_value', ea.STATE).withDescription('Detected gas'),
};
...
const valueConverter = {
    ...
    gasState: valueConverterBasic.lookup({ 'alarm': 0, 'normal': 1 }),
