...
const haozeeThermostatScheduleLookup = {
    'monday_schedule': {
        'dpId': dataPoints.haozeeScheduleMonday,
        'dayNumber': 1,
    },
    'tuesday_schedule': {
        'dpId': dataPoints.haozeeScheduleTuesday,
        'dayNumber': 2,
    },
    'wednesday_schedule': {
        'dpId': dataPoints.haozeeScheduleWednesday,
        'dayNumber': 3,
    },
    'thursday_schedule': {
        'dpId': dataPoints.haozeeScheduleThursday,
        'dayNumber': 4,
    },
    'friday_schedule': {
        'dpId': dataPoints.haozeeScheduleFriday,
        'dayNumber': 5,
    },
    'saturday_schedule': {
        'dpId': dataPoints.haozeeScheduleSaturday,
        'dayNumber': 6,
    },
    'sunday_schedule': {
        'dpId': dataPoints.haozeeScheduleSunday,
        'dayNumber': 7,
    },
};
...
module.exports = {
    ...
    haozeeThermostatScheduleLookup,
};
