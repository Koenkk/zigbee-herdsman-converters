...
const dataPoints = {
    ...
    // Beok TRV thermostat and other with '_TZE200_a4bpgplm' manufactorName
    beokSystemMode: 1,
    beokHeatingSetpoint: 2,
    beokLocalTemp: 3,
    beokBoostHeating: 4,
    beokBoostHeatingCountdown: 5,
    beokRunningState: 6,
    beokWindowState: 7,
    beokWindowDetection: 8,
    beokChildLock: 12,
    beokBattery: 13,
    beokFaultAlarm: 14,
    beokMinTemp: 15,
    beokMaxTemp: 16,
    beokScheduleMonday: 17,
    beokScheduleTuesday: 18,
    beokScheduleWednesday: 19,
    beokScheduleThursday: 20,
    beokScheduleFriday: 21,
    beokScheduleSaturday: 22,
    beokScheduleSunday: 23,
    beokTempCalibration: 101,
    beokValvePosition: 102,
    beokSoftVersion: 150,
    // HY thermostat
    hyHeating: 102,
    hyExternalTemp: 103,
