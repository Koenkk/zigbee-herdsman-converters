...
const tuyaExposes = {
    ...
    temperature: () => exposes.numeric('temperature', ea.STATE).withUnit('°C').withDescription('Measured temperature value'),
    ...
    zg_temp_calibration: () => exposes.numeric('zg_temp_calibration', ea.STATE_SET).withValueMin(-2.0).withValueMax(2.0).withValueStep(0.1).withUnit('°C').withDescription('Temperature calibration'),
