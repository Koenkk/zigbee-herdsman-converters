...
const dataPoints = {
    ...
    // Tesla Smart thermostatic valve
    tsMode: 2,
    tsWindowCheck: 8,
    tsFrostProtection: 10,
    tsSetTemperature: 16,
    tsCurrentTemperature: 24,
    tsTemperatureCorrection: 27,
    tsWorkingdaySet: 31,
    tsHolidayTemperature: 32,
    tsBatteryCapacity: 35,
    tsChildLocl: 40,
    tsFaultAlarm: 45,
    tsHolidayModeSettins: 46,
    tsBoost: 101,
    tsOpenWindowSetting: 102,
    tsComfortableTemperatureSettings: 104,
    tsEcoTempSettings: 105,
    tsWeekProgramming: 106,
    tsHeatingStopping: 107,
    tsMondayProgram: 108,
    tsWednesdayProgram: 109,
    tsFridayProgram: 110,
    tsSundayProgram: 111,
    tsTuesdayProgram: 112,
    tsThursdayProgram: 113,
    tsSaturdayProgram: 114,
    tsCheck01: 115,
};
