...
function convertRawToCycleTimer(value) {
    ...
    return {timernr: timernr, starttime: starttime, endtime: endtime, irrigationDuration: irrigationDuration, pauseDuration: pauseDuration, weekdays: weekdays, active: timeractive};
}
...
function convertTimeTo2ByteHexArray(time) {
    ...
    const time_h = parseInt(timeArray[0]);
    const time_m = parseInt(timeArray[1]);
