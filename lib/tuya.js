...
const valueConverter = {
   ...
   alarm: {
        from: (v) => {
            ...
            const lookup_state = {0: 'OFF', 1: 'ON'};
            return {
                threshold1_state: lookup_state[buffer[1]],
                threshold1_description: lookup[buffer[0]],
                threshold1_value : (buffer[3] | buffer[2] << 8),
                threshold2_state: lookup_state[buffer[5]],
                threshold2_description: lookup[buffer[4]],
                threshold2_value : (buffer[7] | buffer[6] << 8),
            };
        },
    },
...
const tzDataPoints = {
    key: [
        ...
        'online', 'holiday_mode_date', 'schedule','clear_event',
    ],
