...
module.exports = {
    ...
    presets: {
        ...
        consumer_overload: () => new Binary('consumer_overload', access.STATE, true, false).withDescription('Indicates whether the consumer device(s) oveload the device maximim possible power consumption'),
