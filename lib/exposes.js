...
module.exports = {
    ...
    presets: {
        ...
        auto_off: () => new Binary('auto_off', access.STATE, true, false).withDescription('Indicates whether the device has auto off functionality enabled or not'),
        ...
        consumer_connected: () => new Binary('consumer_connected', access.STATE, true, false).withDescription('Indicates whether the device has consumer connected not'),
        ...
        led_disabled: () => new Binary('led_disabled', access.STATE, true, false).withDescription('Indicates whether the device has led disabled state or not'),
        ...
        power_outage_memory: () => new Binary('power_outage_memory', access.STATE, true, false).withDescription('Indicates whether the device has power outagte memory for state enabled or not'),
