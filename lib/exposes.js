...
class Light extends Base {
    ...
    withMinBrightness() {
        assert(!this.endpoint, 'Cannot add feature after adding endpoint');
        this.features.push(new Numeric('min_brightness', access.STATE_SET).withValueMin(1).withValueMax(255).withDescription('Minimum light brightness'));
        return this;
    }
...
module.exports = {
    ...
    presets: {
        ...
        light_brightness_min: () => new Light().withBrightness().withMinBrightness(),
