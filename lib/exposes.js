...
module.exports = {
    ...
    presets: {
        ...
        min_temperature_limit: () => new Numeric('min_temperature_limit', access.STATE_SET).withUnit('°C').withDescription('Maximum temperature limit. Turns the thermostat on regardless of air temperature if the external floor sensor drops below this temperature. Only used by the thermostat when in AL sensor mode.').withValueMin(0).withValueMax(10),
