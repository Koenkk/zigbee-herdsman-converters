...
module.exports = {
    ...
    presets: {
        ...
        muffling: () => new Binary('muffling', access.STATE_SET, true, false).withDescription('Silence the siren'),
        ...
        self_test: () => new Binary('self_test', access.STATE_SET, true, false).withDescription('Indicates whether the device is being tested'),
        self_test_result: () => new Binary('self_test_result', access.STATE, true, false).withDescription('Indicates whether the device test was successful'),
