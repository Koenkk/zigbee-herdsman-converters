...
module.exports = {
    ...
    presets: {
        ...
        keypad_lockout: () => new Binary('keypad_lockout_1', access.ALL, 'lock1', 'unlock').withDescription('Enables/disables physical input on the device'),
        keypad_lockout_2: () => new Binary('keypad_lockout_2', access.ALL, 'lock2', 'unlock').withDescription('Enables/disables physical input on the device'),
