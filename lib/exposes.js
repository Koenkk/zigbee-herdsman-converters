...
module.exports = {
    ...
    presets: {
        ...
        led_disabled_night: () => new Binary('led_disabled_night', access.STATE, true, false).withDescription('Indicates whether the device has LED disable at night state or not'),
        ...
        power_outage_memory: () => new Binary('power_outage_memory', access.STATE, true, false).withDescription('Indicates whether the device has power outage memory, to recover mode on/off after power fail, enabled or not'),
