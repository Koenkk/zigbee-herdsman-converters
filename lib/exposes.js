...
module.exports = {
    ...
    presets: {
        ...
        auto_off: () => new Binary('auto_off', access.STATE_SET, true, false).withDescription('Indicates whether the device has auto off with low consumer load functionality enabled or not'),
        ...
        consumer_connected: () => new Binary('consumer_connected', access.STATE, true, false).withDescription('Indicates whether the device has consumer device(s) connected or not'),
        consumer_overload: () => new Numeric('consumer_overload', access.STATE_GET, true, false).withUnit('W').withDescription('Indicates whether the consumer device(s) oveload the device maximim possible power consumption'),
        ...
        led_disabled_night: () => new Binary('led_disabled_night', access.STATE_SET, true, false).withDescription('Indicates whether the device has LED disable at night state or not'),
        ...
        power_outage_memory: () => new Binary('power_outage_memory', access.STATE_SET, true, false).withDescription('Indicates whether the device has power outage memory, to recover mode on/off after power fail, enabled or not'),
