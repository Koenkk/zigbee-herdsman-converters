...
module.exports = {
    ...
    options: {
        // todo fix precision/calibraiton illumiance
        ...
        occupancy_timeout: () => new Numeric(`occupancy_timeout`).withValueMin(0).withDescription('Time in seconds after which occupancy is cleared after detecting occupancy (default 90 seconds)'),
        vibration_timeout: () => new Numeric(`vibration_timeout`).withValueMin(0).withDescription('Time in seconds after which vibration is cleared after detecting vibration (default 90 seconds)'),
        simulated_brightness: () => new Binary(`simulated_brightness`, null, true, false).withDescription(`TODO`),
        no_occupancy_since: () => new Binary(`no_occupancy_since`, null, true, false), // TODO
        precense_timeout: () => new Numeric(`precense_timeout`).withValueMin(0).withDescription('TODO'),
        // todo add no position suport
        // hold timeout
        // hold tiemout expire
        // add legacy option
        // check devices.js options
        // clarify that new message is needed for device options to be applied
    },
    presets: {
