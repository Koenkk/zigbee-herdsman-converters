...
module.exports = {
    ...
    presets: {
        ...
        schedule: () => new List('schedule', access.STATE_SET, new Composite('period', access.SET)
            .withFeature(new Numeric('hours', access.SET))
            .withFeature(new Numeric('minutes', access.SET))
            .withFeature(new Numeric('temperature', access.SET))),
    },
};
