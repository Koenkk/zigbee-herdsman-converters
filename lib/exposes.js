...
module.exports = {
    ...
    presets: {
        ...
        auto_off: (offTime) => new Binary('auto_off', access.STATE_SET, true, false).withDescription(`Turn the device automatically off when attached device consumes less than 2W for ${offTime} minutes`),
