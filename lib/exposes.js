...
module.exports = {
    ...
    presets: {
        ...
        max_cool_setpoint_limit: () => new Numeric('max_cool_setpoint_limit', access.STATE_SET).withUnit('°C').withDescription('Maximum Heat set point limit').withValueMin(7).withValueMax(35),
        min_cool_setpoint_limit: () => new Numeric('min_cool_setpoint_limit', access.STATE_SET).withUnit('°C').withDescription('Minimum Heat set point limit').withValueMin(7).withValueMax(35),
        max_heat_setpoint_limit: () => new Numeric('max_heat_setpoint_limit', access.STATE_SET).withUnit('°C').withDescription('Maximum Heat set point limit').withValueMin(5).withValueMax(30),
        min_heat_setpoint_limit: () => new Numeric('min_heat_setpoint_limit', access.STATE_SET).withUnit('°C').withDescription('Minimum Heat set point limit').withValueMin(5).withValueMax(30),
