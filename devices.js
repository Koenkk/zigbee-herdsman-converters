...
const devices = [
    ...
    },
    {
        ...
        model: 'DNCKATSW001',
        vendor: 'Custom devices (DiY)',
        description: '[DNCKAT single key wired wall light switch](https://dzungpv.github.io/dnckatsw00x/)',
        supports: 'on/off',
    ...
    },
    {
        ...
        model: 'DNCKATSW002',
        vendor: 'Custom devices (DiY)',
        description: '[DNCKAT double key wired wall light switch](https://dzungpv.github.io/dnckatsw00x/)',
        supports: 'left and right on/off',
        fromZigbee: [fz.DNCKAT_S002_state, fz.DNCKAT_S002_buttons],
        toZigbee: [tz.onoff],
        ep: {'left': 1, 'right': 2},
    },
    {
        ...
        model: 'DNCKATSW003',
        vendor: 'Custom devices (DiY)',
        description: '[DNCKAT triple key wired wall light switch](https://dzungpv.github.io/dnckatsw00x/)',
        supports: 'left, center and right on/off',
        fromZigbee: [fz.DNCKAT_S003_state, fz.DNCKAT_S003_buttons],
        toZigbee: [tz.onoff],
    ...
    },
    {
        ...
        model: 'DNCKATSW004',
        vendor: 'Custom devices (DiY)',
        description: '[DNCKAT quadruple key wired wall light switch](https://dzungpv.github.io/dnckatsw00x/)',
        supports: 'top left, top right, bottom left and bottom right on/off',
        fromZigbee: [fz.DNCKAT_S004_state, fz.DNCKAT_S004_buttons],
        toZigbee: [tz.onoff],
