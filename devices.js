...
const preset = {
  ...
  light_onoff_brightness_colortemp: {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      for (const endpoint of device.endpoints.filter((e) =>
        e.supportsInputCluster('lightingColorCtrl')
      )) {
        try {
...
};
{
  ...
  preset.hue = {
    light_onoff_brightness: {
      ...preset.light_onoff_brightness,
      toZigbee: preset.light_onoff_brightness.toZigbee.concat([
        tz.hue_power_on_behavior,
        tz.hue_power_on_error,
      ]),
    },
    light_onoff_brightness_colortemp: {
      ...preset.light_onoff_brightness_colortemp,
      toZigbee: preset.light_onoff_brightness_colortemp.toZigbee.concat([
        tz.hue_power_on_behavior,
        tz.hue_power_on_error,
      ]),
    },
    light_onoff_brightness_color: {
      ...
      toZigbee: preset.light_onoff_brightness_color.toZigbee.concat([
        tz.hue_power_on_behavior,
        tz.hue_power_on_error,
      ]),
    },
    light_onoff_brightness_colortemp_color: {
      ...
      toZigbee: preset.light_onoff_brightness_colortemp_color.toZigbee.concat([
        tz.hue_power_on_behavior,
        tz.hue_power_on_error,
      ]),
    },
...
const devices = [
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_battery,
      fz.xiaomi_WXKG01LM_action,
      fz.legacy.WXKG01LM_click,
    ],
    exposes: [
      e.battery(),
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.xiaomi_WXKG11LM_action,
      fz.xiaomi_battery,
      fz.legacy.WXKG11LM_click,
      fz.legacy.xiaomi_action_click_multistate,
    ],
    toZigbee: [],
  },
  {
    ...
    exposes: [
      e.battery(),
      e.action(['single', 'double', 'hold', 'release', 'shake']),
    ],
    fromZigbee: [
      fz.xiaomi_battery,
      fz.xiaomi_multistate_action,
      fz.legacy.WXKG12LM_action_click_multistate,
    ],
    toZigbee: [],
  },
  {
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.xiaomi_battery,
      fz.legacy.WXKG02LM_click,
      fz.legacy.WXKG02LM_click_multistate,
    ],
    toZigbee: [],
    onEvent: xiaomi.preventReset,
  },
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_on_off_ignore_endpoint_4_5_6,
      fz.xiaomi_on_off_action,
      fz.legacy.QBKG04LM_QBKG11LM_click,
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_on_off_action,
      fz.xiaomi_on_off_ignore_endpoint_4_5_6,
      fz.legacy.QBKG03LM_QBKG12LM_click,
      fz.legacy.QBKG03LM_buttons,
      fz.xiaomi_operation_mode_basic,
      fz.xiaomi_switch_basic,
    ],
    exposes: [
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_battery,
      fz.legacy.xiaomi_on_off_action,
      fz.legacy.xiaomi_multistate_action,
    ],
    toZigbee: [],
    endpoint: (device) => {
  ...
  },
  {
    ...
    fromZigbee: [
      fz.on_off,
      fz.legacy.QBKG25LM_click,
      fz.xiaomi_operation_mode_opple,
    ],
    toZigbee: [
      tz.on_off,
      tz.xiaomi_switch_operation_mode,
      tz.xiaomi_switch_power_outage_memory,
      tz.xiaomi_switch_do_not_disturb,
    ],
    meta: { multiEndpoint: true, configureKey: 1 },
    endpoint: (device) => {
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_battery,
      fz.occupancy_with_timeout,
      fz.RTCGQ11LM_illuminance,
  ...
  },
  {
    ...
    exposes: [
      ...
      e.power_outage_memory(),
      exposes
        .binary('auto_off', exposes.access.STATE_SET, true, false)
        .withDescription(
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.JTYJGD01LMBW_smoke_density,
    ],
    toZigbee: [
      tz.JTQJBF01LMBW_JTYJGD01LMBW_sensitivity,
      tz.JTQJBF01LMBW_JTYJGD01LMBW_selfest,
    ],
    exposes: [
      e.smoke(),
      e.battery_low(),
      e.tamper(),
      e.battery(),
      exposes.enum('sensitivity', exposes.access.ALL, [
        'low',
        'medium',
        'high',
      ]),
      exposes.numeric('smoke_density', exposes.access.STATE),
      exposes.enum('selftest', exposes.access.SET, ['']),
    ],
  },
  {
    ...
    exposes: [
      ...
      exposes.numeric('gas_density', exposes.access.STATE),
      exposes.enum('selftest', exposes.access.SET, ['']),
    ],
  },
  {
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes.numeric('strength', exposes.access.STATE),
      exposes.enum('sensitivity', exposes.access.STATE_SET, [
        'low',
        'medium',
        'high',
      ]),
  ...
  },
  {
    ...
    vendor: 'Xiaomi',
    fromZigbee: [
      fz.xiaomi_curtain_position,
      fz.cover_position_tilt,
      fz.xiaomi_curtain_options,
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary('interlock', exposes.access.STATE_SET, true, false)
        .withDescription(
  ...
  },
  {
    ...
    vendor: 'Xiaomi',
    fromZigbee: [
      fz.ZNMS12LM_ZNMS13LM_closuresDoorLock_report,
      fz.ZNMS12LM_low_battery,
      fz.xiaomi_battery,
    ],
    toZigbee: [],
    exposes: [
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.aqara_opple_off,
      fz.battery,
      fz.aqara_opple_multistate,
      fz.aqara_opple_report,
    ],
    exposes: [
      e.battery(),
      e.action([
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .enum('operation_mode', exposes.access.ALL, ['command', 'event'])
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes.enum('backlight_mode', exposes.access.ALL, [
        'LOW',
        'MEDIUM',
        'HIGH',
      ]),
  ...
  },
  {
    ...
    meta: {
      tuyaThermostatPreset: tuya.thermostatPresets,
      tuyaThermostatSystemMode: tuya.thermostatSystemModes3,
    },
    ota: ota.zigbeeOTA,
    ...
    toZigbee: [
      ...
      tz.tuya_thermostat_force_to_mode,
    ...
    exposes: [
      ...
      exposes
        ...
        .withSystemMode(['heat', 'auto', 'off'], exposes.access.STATE_SET)
  ...
  },
  {
    ...
    exposes: [
      ...
      e.energy(),
      exposes
        .enum('power_outage_memory', exposes.access.STATE_SET, [
          'on',
          'off',
          'restore',
        ])
  ...
  },
  {
    ...
    meta: {
      tuyaThermostatSystemMode: tuya.thermostatSystemModes2,
      tuyaThermostatPreset: tuya.thermostatPresets,
    },
    toZigbee: [
      tz.tuya_thermostat_current_heating_setpoint,
  ...
  // Neo
  {
    ...
    exposes: [
      e.temperature(),
      e.humidity(),
      exposes.binary('humidity_alarm', exposes.access.ALL, true, false),
  ...
  },
  {
    ...
    fromZigbee: [
      fz.legacy.cmd_move,
      fz.legacy.cmd_move_with_onoff,
      fz.legacy.cmd_stop,
      fz.legacy.cmd_stop_with_onoff,
      fz.legacy.cmd_move_to_level_with_onoff,
      fz.battery,
    ],
    exposes: [
      e.battery(),
  ...
  },
  {
    ...
    exposes: preset.switch.exposes.concat([
      exposes
        .enum('power_on_behavior', exposes.access.STATE_SET, [
          'off',
          'previous',
          'on',
        ])
  ...
  },
  {
    ...
    fromZigbee: [
      fz.battery,
      fz.E1524_E1810_toggle,
      fz.E1524_E1810_levelctrl,
      fz.E1524_E1810_arrow_click,
      fz.E1524_E1810_arrow_hold,
  ...
  },
  {
    ...
    fromZigbee: [
      fz.command_on,
      fz.legacy.genOnOff_cmdOn,
      fz.command_off,
      fz.legacy.genOnOff_cmdOff,
      fz.command_move,
      fz.battery,
      fz.legacy.E1743_brightness_up,
      fz.legacy.E1743_brightness_down,
      fz.command_stop,
  ...
  },
  {
    ...
    exposes: [
      e.battery(),
      e.action(['on', 'brightness_move_up', 'brightness_stop']),
    ],
    toZigbee: [],
    ota: ota.tradfri,
    meta: {
  ...
  },
  {
    ...
    fromZigbee: [
      fz.legacy.cmd_move,
      fz.legacy.cmd_stop,
      fz.legacy.E1744_play_pause,
      fz.legacy.E1744_skip,
      fz.battery,
    ],
    toZigbee: [],
    exposes: [
  ...
  },
  {
    ...
    exposes: [
      ...
      e.occupancy(),
      exposes
        .numeric('requested_brightness_level', exposes.access.STATE)
        .withValueMin(76)
        .withValueMax(254),
      exposes
        .numeric('requested_brightness_percent', exposes.access.STATE)
        .withValueMin(30)
        .withValueMax(100),
    ],
    ota: ota.tradfri,
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.legacy.cover_close,
      fz.command_cover_open,
      fz.legacy.cover_open,
      fz.command_cover_stop,
      fz.legacy.cover_stop,
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      e.illuminance_lux(),
      e.illuminance(),
      exposes.enum('motion_sensitivity', exposes.access.ALL, [
        'low',
        'medium',
        'high',
      ]),
      exposes
        .numeric('occupancy_timeout', exposes.access.ALL)
        .withUnit('second')
        .withValueMin(0)
        .withValueMax(65535),
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      e.pressure(),
      e.humidity(),
      e.action(['single', 'double', 'tripple', 'hold']),
    ],
    meta: { multiEndpoint: true },
    endpoint: (device) => {
      return {
  ...
  },
  {
    ...
    exposes: [
      ...
      e.switch().withEndpoint('top_left'),
      e.switch().withEndpoint('top_right'),
      e.action([
        'release_bottom_left',
        'hold_bottom_left',
  ...
  // databyte.ch
  {
    ...
    exposes: [
      ...
      exposes.enum('key_state', exposes.access.STATE, [
        'KEY_SYS',
        'KEY_UP',
        'KEY_DOWN',
        'KEY_NONE',
  ...
  },
  {
    ...
    fromZigbee: [
      fz.diyruz_freepad_clicks,
      fz.diyruz_freepad_config,
      fz.battery,
    ],
    exposes: [
      e.battery(),
      ...
      ((enpoinsCount) => {
        ...
        for (let i = 1; i <= enpoinsCount; i++) {
          ...
          features.push(
            exposes
              .enum('switch_type', exposes.access.ALL, [
                'toggle',
                'momentary',
                'multifunction',
              ])
          ...
          features.push(
            exposes
              .enum('switch_actions', exposes.access.ALL, [
                'on',
                'off',
                'toggle',
              ])
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.command_on,
      fz.command_off,
      fz.diyruz_geiger_config,
    ],
    exposes: [
      e.action(['on', 'off']),
      exposes
        .numeric('radioactive_events_per_minute', exposes.access.STATE)
        .withUnit('rpm')
        .withDescription('Current count radioactive pulses per minute'),
      exposes
        .numeric('radiation_dose_per_hour', exposes.access.STATE)
        .withUnit('μR/h')
        .withDescription('Current radiation level'),
      exposes
        .binary('led_feedback', exposes.access.ALL, 'ON', 'OFF')
        .withDescription('Enable LED feedback'),
      exposes
        .binary('buzzer_feedback', exposes.access.ALL, 'ON', 'OFF')
        .withDescription('Enable buzzer feedback'),
      exposes
        .numeric('alert_threshold', exposes.access.ALL)
        .withUnit('μR/h')
        .withDescription('Critical radiation level'),
      exposes
        .enum('sensors_type', exposes.access.ALL, [
          'СБМ-20/СТС-5/BOI-33',
          'СБМ-19/СТС-6',
          'Others',
        ])
      ...
      exposes
        .numeric('sensors_count', exposes.access.ALL)
        .withDescription('Count of installed tubes'),
      exposes
        .numeric('sensitivity', exposes.access.ALL)
        .withDescription('This is applicable if tubes type is set to other'),
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      e.pressure(),
      exposes
        .numeric('temperature_ds', exposes.access.STATE)
        .withUnit('°C')
        .withDescription('Measured temperature value'),
      exposes
        .numeric('temperature_bme', exposes.access.STATE)
        .withUnit('°C')
        .withDescription('Measured temperature value'),
    ],
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary('led_feedback', exposes.access.ALL, 'ON', 'OFF')
        .withDescription('Enable LEDs feedback'),
      exposes
        .binary('enable_abc', exposes.access.ALL, 'ON', 'OFF')
        .withDescription('Enable ABC (Automatic Baseline Correction)'),
      exposes
        .numeric('threshold1', exposes.access.ALL)
        .withUnit('ppm')
        .withDescription('Warning (LED2) CO2 level'),
      exposes
        .numeric('threshold2', exposes.access.ALL)
        .withUnit('ppm')
        .withDescription('Critical (LED3) CO2 level'),
      exposes
        .numeric('temperature_offset', exposes.access.ALL)
        .withUnit('°C')
        .withDescription('Adjust temperature'),
      exposes
        .numeric('humidity_offset', exposes.access.ALL)
        .withUnit('%')
        .withDescription('Adjust humidity'),
      exposes
        .numeric('pressure_offset', exposes.access.ALL)
        .withUnit('hPa')
        .withDescription('Adjust pressure'),
    ],
  },
  ...
  },
  {
    ...
    fromZigbee: [
      fz.legacy.osram_lightify_switch_cmdOn,
      fz.legacy.osram_lightify_switch_cmdMoveWithOnOff,
      fz.legacy.osram_lightify_switch_AC0251100NJ_cmdStop,
      fz.legacy.osram_lightify_switch_cmdMoveToColorTemp,
      fz.legacy.osram_lightify_switch_cmdMoveHue,
      fz.legacy.osram_lightify_switch_cmdMoveToSaturation,
      fz.legacy.osram_lightify_switch_cmdOff,
      fz.legacy.osram_lightify_switch_cmdMove,
      fz.battery,
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      await reporting.bind(endpoint4, coordinatorEndpoint, [
        'genLevelCtrl',
        'lightingColorCtrl',
      ]);
      await reporting.batteryVoltage(endpoint1);
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.legacy.thermostat_weekly_schedule_rsp,
    ],
    toZigbee: [
      tz.thermostat_local_temperature,
      tz.thermostat_system_mode,
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      await reporting.thermostatTemperature(
        heatEndpoint,
        0,
        repInterval.HOUR,
        1
  ...
  // Sylvania
  {
    ...
    fromZigbee: [
      ...
      fz.legacy.osram_lightify_switch_cmdOff,
      fz.legacy.osram_lightify_switch_cmdMove,
      fz.legacy.osram_lightify_switch_73743_cmdStop,
      fz.battery,
    ],
    exposes: [
      e.battery(),
  ...
  },
  {
    ...
    fromZigbee: [
      fz.command_recall,
      fz.legacy.scenes_recall_click,
      fz.ignore_power_report,
    ],
  ...
  },
  {
    ...
    meta: { configureKey: 1, multiEndpoint: true },
    configure: async (device, coordinatorEndpoint, logger) => {
      await reporting.bind(device.getEndpoint(16), coordinatorEndpoint, [
        'genOnOff',
      ]);
      await reporting.bind(device.getEndpoint(17), coordinatorEndpoint, [
        'genOnOff',
      ]);
      await reporting.bind(device.getEndpoint(18), coordinatorEndpoint, [
        'genOnOff',
      ]);
    },
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      await reporting.bind(device.getEndpoint(19), coordinatorEndpoint, [
        'genOnOff',
      ]);
    },
  },
  ...
  },
  {
    ...
    meta: { configureKey: 1, multiEndpoint: true },
    configure: async (device, coordinatorEndpoint, logger) => {
      await reporting.bind(device.getEndpoint(11), coordinatorEndpoint, [
        'genOnOff',
      ]);
      await reporting.bind(device.getEndpoint(12), coordinatorEndpoint, [
        'genOnOff',
      ]);
    },
  },
  ...
  },
  {
    ...
    meta: {
      disableDefaultResponse: (entity) => !!entity.getDevice().getEndpoint(12),
    },
    vendor: 'Gledopto',
  ...
  },
  {
    ...
    extend: preset.gledopto.light_onoff_brightness_colortemp_colorxy,
    exposes: [
      e.light_brightness_colortemp_colorxy().withEndpoint('rgb'),
      e.light_brightness().withEndpoint('white'),
    ],
    endpoint: (device) => {
      if (
        device.getEndpoint(10) &&
        device.getEndpoint(11) &&
        device.getEndpoint(13)
      ) {
        return { rgb: 11, white: 10 };
      } else if (
        device.getEndpoint(11) &&
        device.getEndpoint(12) &&
        device.getEndpoint(13)
      ) {
  ...
  },
  {
    ...
    exposes: [
      ...
      e.light_brightness_colortemp().withEndpoint('cct'),
    ],
    // Only enable disableDefaultResponse for the second fingerprint:
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.battery,
      fz.legacy.STS_PRS_251_beeping,
    ],
    exposes: [
      e.battery(),
      e.presence(),
      e.action(['beeping']),
      exposes.enum('beep', exposes.access.SET, ['']),
    ],
  ...
  },
  {
    ...
    fromZigbee: [
      fz.command_on,
      fz.command_off_with_effect,
      fz.legacy.ZYCT202_stop,
      fz.legacy.ZYCT202_up_down,
    ],
  ...
  // ksentry
  {
    ...
    description:
      '[Zigbee OnOff Controller](http://ksentry.manufacturer.globalsources.com/si/6008837134660' +
  ...
  },
  {
    ...
    exposes: [
      ...
      e.aqi(),
      e.pm10(),
      exposes.enum('battery_state', exposes.access.STATE, [
        'not_charging',
        'charging',
        'charged',
      ]),
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.command_off,
      fz.legacy.genOnOff_cmdOff,
      fz.legacy.CTR_U_brightness_updown_click,
      fz.ignore_basic_report,
      fz.legacy.CTR_U_brightness_updown_hold,
      fz.legacy.CTR_U_brightness_updown_release,
      fz.command_recall,
      fz.legacy.CTR_U_scene,
    ],
    toZigbee: [],
  },
  {
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      if (
        switchEndpoint10 != null &&
        switchEndpoint10.supportsOutputCluster('genOnOff')
      ) {
        // https://github.com/Koenkk/zigbee2mqtt/issues/3027#issuecomment-606169628
        await reporting.bind(switchEndpoint10, coordinatorEndpoint, [
          'genOnOff',
        ]);
      }
      ...
      if (switchEndpoint12 != null) {
        firstEndpoint++;
        await reporting.bind(switchEndpoint12, coordinatorEndpoint, [
          'genOnOff',
          'genLevelCtrl',
        ]);
      }
    ...
    fromZigbee: [
      ...
      fz.on_off,
      fz.brightness,
      fz.legacy.RM01_on_click,
      fz.legacy.RM01_off_click,
      fz.legacy.RM01_up_hold,
      fz.legacy.RM01_down_hold,
      fz.legacy.RM01_stop,
    ],
    toZigbee: [
      tz.RM01_light_onoff_brightness,
      tz.RM01_light_brightness_step,
      tz.RM01_light_brightness_move,
    ],
    onEvent: async (type, data, device) => {
  ...
  },
  {
    ...
    extend: preset.light_onoff_brightness_colortemp_colorxy,
    toZigbee: preset.light_onoff_brightness_colortemp_colorxy.toZigbee.concat([
      tz.tint_scene,
    ]),
  },
  {
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.command_off,
      fz.command_toggle,
      fz.legacy.tint404011_brightness_updown_click,
      fz.legacy.tint404011_move_to_color_temp,
      fz.legacy.tint404011_move_to_color,
      fz.tint_scene,
      fz.legacy.tint404011_brightness_updown_release,
      fz.legacy.tint404011_brightness_updown_hold,
    ],
    exposes: [
      e.action([
        'on',
        ...
        'color_temp',
        'color_wheel',
        'brightness_0_release',
        'brightness_1_release',
        'brightness_0_hold',
        'brightness_1_hold',
      ]),
    ],
  ...
  // Danfoss
  {
    ...
    toZigbee: [
      ...
      tz.danfoss_thermostat_orientation,
    ...
    exposes: [
      ...
      exposes
        .climate()
        .withSetpoint('occupied_heating_setpoint', 6, 28, 0.5)
        .withLocalTemperature()
        .withPiHeatingDemand(),
    ],
    meta: { configureKey: 3 },
  ...
  // Eurotronic
  {
    ...
    toZigbee: [
      ...
      tz.thermostat_unoccupied_heating_setpoint,
      tz.thermostat_local_temperature_calibration,
      tz.eurotronic_thermostat_system_mode,
      ...
      if (['start', 'deviceAnnounce'].includes(type)) {
        ...
        if (!globalStore.hasValue(device, 'interval')) {
          const interval = setInterval(
            async () => await livolo.poll(device),
            300 * 1000
          );
          globalStore.putValue(device, 'interval', interval);
        }
  ...
  },
  {
    ...
    fromZigbee: preset.light_onoff_brightness.fromZigbee.concat([
      fz.electrical_measurement,
      fz.metering,
      fz.ignore_genOta,
    ]),
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.command_step,
      fz.command_recall,
      fz.ZG2819S_command_on,
      fz.ZG2819S_command_off,
    ],
    exposes: [
      e.battery(),
      e.action([
  ...
  // Insta
  {
    ...
    fromZigbee: [
      fz.legacy.insta_scene_click,
      fz.command_on,
      fz.command_off_with_effect,
      fz.legacy.insta_down_hold,
      fz.legacy.insta_up_hold,
      fz.legacy.insta_stop,
    ],
  ...
  },
  {
    ...
    fromZigbee: [
      fz.battery,
      fz.command_move,
      fz.legacy.ZGRC013_brightness_onoff,
      fz.legacy.ZGRC013_brightness,
      fz.command_stop,
      fz.legacy.ZGRC013_brightness_stop,
      fz.command_on,
      fz.legacy.ZGRC013_cmdOn,
      fz.command_off,
      fz.legacy.ZGRC013_cmdOff,
      fz.command_recall,
    ],
    exposes: [
      e.battery(),
  ...
  },
  {
    ...
    exposes: [
      e.action(['brightness']),
      exposes.numeric('brightness', exposes.access.STATE),
    ],
    meta: { configureKey: 1 },
    configure: async (device, coordinatorEndpoint, logger) => {
      const endpoint = device.getEndpoint(1);
  ...
  },
  {
    ...
    exposes: [
      ...
      e.switch().withEndpoint('bottom_left'),
      e.switch().withEndpoint('center_left'),
      e.switch().withEndpoint('center_right'),
      e.switch().withEndpoint('top_right'),
      e.switch().withEndpoint('bottom_right'),
    ],
    endpoint: (device) => {
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.level_config,
      fz.ubisys_dimmer_setup,
    ],
    toZigbee: [
      tz.light_onoff_brightness,
      tz.ballast_config,
      tz.level_config,
      tz.ubisys_dimmer_setup,
      tz.ubisys_device_setup,
    ],
    exposes: [
      e.light_brightness().withLevelConfig(),
      e.power(),
      exposes
        .numeric('ballast_physical_minimum_level', exposes.access.STATE_GET)
        .withValueMin(1)
        .withValueMax(254)
        .withDescription(
      ...
      exposes
        .numeric('ballast_physical_maximum_level', exposes.access.STATE_GET)
        .withValueMin(1)
        .withValueMax(254)
        .withDescription(
      ...
      exposes
        .numeric('ballast_minimum_level', exposes.access.ALL)
        .withValueMin(1)
        .withValueMax(254)
        .withDescription('Specifies the minimum light output of the ballast'),
      exposes
        .numeric('ballast_maximum_level', exposes.access.ALL)
        .withValueMin(1)
        .withValueMax(254)
      ...
      exposes
        .binary('status_overload', exposes.access.STATE_GET, true, false)
        .withDescription(
          'The output is currently turned off, because the dimmer has detected an overload.'
        ),
      exposes
        .binary('status_capacitive_load', exposes.access.STATE_GET, true, false)
        .withDescription(
          "The dimmer's reactance discriminator had detected a capacitive load."
        ),
      exposes
        .binary('status_inductive_load', exposes.access.STATE_GET, true, false)
        .withDescription(
          "The dimmer's reactance discriminator had detected an inductive load."
        ),
      exposes
        .enum('mode_phase_control', exposes.access.ALL, [
          'automatic',
          'forward',
          'reverse',
        ])
  ...
  },
  {
    ...
    fromZigbee: [
      fz.legacy.ubisys_c4_scenes,
      fz.legacy.ubisys_c4_onoff,
      fz.legacy.ubisys_c4_level,
      fz.legacy.ubisys_c4_cover,
    ],
  ...
  },
  {
    ...
    fromZigbee: [
      fz.terncy_temperature,
      fz.occupancy_with_timeout,
      fz.illuminance,
      fz.terncy_raw,
      fz.legacy.terncy_raw,
      fz.battery,
    ],
    exposes: [
      e.temperature(),
  ...
  },
  {
    ...
    exposes: [
      e.battery(),
      e.action(['single', 'double', 'triple', 'quadruple', 'rotate']),
  ...
  },
  {
    ...
    fromZigbee: [
      fz.curtain_position_analog_output,
      fz.cover_position_tilt,
      fz.ignore_basic_report,
    ],
    toZigbee: [tz.cover_state, tz.cover_position_tilt],
  ...
  // eWeLink
  {
    ...
    extend: preset.switch,
    fromZigbee: [
      fz.on_off_skip_duplicate_transaction_and_disable_default_response,
    ],
    meta: { configureKey: 1 },
    configure: async (device, coordinatorEndpoint, logger) => {
      const endpoint = device.getEndpoint(1);
  ...
  },
  {
    ...
    toZigbee: [
      ...
      tz.moes_thermostat_standby,
      tz.moes_thermostat_sensor,
      tz.moes_thermostat_calibration,
      tz.moes_thermostat_min_temperature,
    ],
    exposes: [
      e.child_lock(),
      exposes
        ...
        .withLocalTemperature(exposes.access.STATE)
        .withSystemMode(['off', 'heat'], exposes.access.STATE_SET)
        .withRunningState(['idle', 'heat', 'cool'], exposes.access.STATE)
  ...
  // Legrand
  {
    ...
    fromZigbee: [
      ...
      fz.on_off,
      fz.electrical_measurement,
      fz.legrand_device_mode,
      fz.ignore_basic_report,
      fz.ignore_genOta,
    ],
    toZigbee: [
      tz.legrand_deviceMode,
      tz.on_off,
      tz.legrand_identify,
    ...
    exposes: [
      exposes
        ...
        .withState(
          'state',
          true,
          'On/off (works only if device is in "switch" mode)'
        ),
      e.power(),
      exposes
        .enum('device_mode', exposes.access.ALL, ['switch', 'auto'])
        .withDescription(
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary('power_alarm', exposes.access.ALL, true, false)
        .withDescription('Enable/disable the power alarm'),
    ],
    meta: { configureKey: 1 },
    configure: async (device, coordinatorEndpoint, logger) => {
      const endpoint = device.getEndpoint(1);
  ...
  },
  {
    ...
    meta: {
      multiEndpoint: true,
      configureKey: 1,
      battery: { voltageToPercentage: '3V_2100' },
    },
    endpoint: (device) => {
  ...
  // Siterwell
  {
    ...
    meta: {
      tuyaThermostatSystemMode: tuya.thermostatSystemModes,
      tuyaThermostatPreset: tuya.thermostatPresets,
    },
    toZigbee: [
      tz.tuya_thermostat_child_lock,
    ...
    whiteLabel: [
      {
        vendor: 'Essentials',
        description: 'Smart home heizkörperthermostat premium',
        model: '120112',
      },
      { vendor: 'TuYa', description: 'Głowica termostatyczna', model: 'GTZ02' },
      {
        vendor: 'Revolt',
        description: 'Thermostatic Radiator Valve Controller',
        model: 'NX-4911',
      },
    ],
    exposes: [
  ...
  },
  {
    ...
    whiteLabel: [
      {
        vendor: 'EnOcean',
        description: 'Easyfit 1 or 2 gang switch',
        model: 'EWSxZG',
      },
    ],
  },
  ...
  // Viessmann
  {
    ...
    fromZigbee: [
      fz.legacy.viessmann_thermostat_att_report,
      fz.battery,
      fz.legacy.hvac_user_interface,
    ],
    toZigbee: [
  ...
  // QMotion products - http://www.qmotionshades.com/
  {
    ...
    exposes: [
      e.action(['identify']),
      exposes.numeric('position', exposes.access.STATE),
    ],
    toZigbee: [],
  },
  {
  ...
  // Fantem
  {
    ...
    exposes: [
      ...
      e.humidity(),
      exposes
        .numeric('reporting_time', exposes.access.STATE_SET)
        .withDescription('Reporting interval in minutes'),
      exposes
        .numeric('temperature_calibration', exposes.access.STATE_SET)
        .withDescription('Temperature calibration'),
      exposes
        .numeric('humidity_calibration', exposes.access.STATE_SET)
        .withDescription('Humidity calibration'),
      exposes
        .numeric('illuminance_calibration', exposes.access.STATE_SET)
        .withDescription('Illuminance calibration'),
      exposes
        .binary('pir_enable', exposes.access.STATE_SET, true, false)
        .withDescription('Enable PIR sensor'),
      exposes
        .binary('led_enable', exposes.access.STATE_SET, true, false)
        .withDescription('Enabled LED'),
      exposes
        .binary('reporting_enable', exposes.access.STATE_SET, true, false)
        .withDescription('Enabled reporting'),
      exposes
        .enum('sensitivity', exposes.access.STATE_SET, [
          'low',
          'medium',
          'high',
        ])
      ...
      // eslint-disable-next-line
      exposes
        .enum('keep_time', exposes.access.STATE_SET, [
          '0',
          '30',
          '60',
          '120',
...
module.exports = devices.map((device) => {
  if (device.extend) {
    if (
      device.extend.hasOwnProperty('configure') &&
      device.hasOwnProperty('configure')
    ) {
      assert.fail(
        `'${device.model}' has configure in extend and device, this is not allowed`
      );
    }
