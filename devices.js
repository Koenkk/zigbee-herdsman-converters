...
const devices = [
    ...
    // Nue, 3A
    {
        ...
        supports: 'Temperature and Humidity',
        toZigbee: [],
        fromZigbee: [fz.generic_temperature, fz.xiaomi_humidity, fz.ignore_basic_change, fz.ignore_temperature_change,],
    },
    {
    ...
    },
    {
        ...
        configure: (ieeeAddr, shepherd, coordinator, callback) => {
            ...
            execute(ep11, [(cb) => ep11.bind('genOnOff', coordinator, cb)], () => {
                ...
                execute(ep12, [(cb) => ep12.bind('genOnOff', coordinator, cb)], () => {
                });
            });
        },
    },
