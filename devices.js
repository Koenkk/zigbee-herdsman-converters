...
const devices = [
    ...
    {
        zigbeeModel: ['5060730P7_01'],
        model: '5060730P7_01',
        vendor: 'Philips',
        description: 'Philips Hue Bluetooth White & Color Ambiance Spot Centris Center',
        meta: {turnsOffAtBrightness1: true},
        extend: hue.light_onoff_brightness_colortemp_colorxy,
        ota: ota.zigbeeOTA,
    },
    {
        zigbeeModel: ['5060730P7_02'],
        model: '5060730P7_02',
        vendor: 'Philips',
        description: 'Philips Hue Bluetooth White & Color Ambiance Spot Centris Spot 1',
        meta: {turnsOffAtBrightness1: true},
        extend: hue.light_onoff_brightness_colortemp_colorxy,
        ota: ota.zigbeeOTA,
    },
    {
        zigbeeModel: ['5060730P7_03'],
        model: '5060730P7_03',
        vendor: 'Philips',
        description: 'Philips Hue Bluetooth White & Color Ambiance Spot Centris Spot 2',
        meta: {turnsOffAtBrightness1: true},
        extend: hue.light_onoff_brightness_colortemp_colorxy,
        ota: ota.zigbeeOTA,
    },
    {
        zigbeeModel: ['5060730P7_04'],
        model: '5060730P7_04',
        vendor: 'Philips',
        description: 'Philips Hue Bluetooth White & Color Ambiance Spot Centris Spot 3',
        meta: {turnsOffAtBrightness1: true},
        extend: hue.light_onoff_brightness_colortemp_colorxy,
        ota: ota.zigbeeOTA,
    },
    {
        zigbeeModel: ['5060730P7_05'],
        model: '5060730P7_05',
        vendor: 'Philips',
        description: 'Philips Hue Bluetooth White & Color Ambiance Spot Centris Spot 4',
        meta: {turnsOffAtBrightness1: true},
        extend: hue.light_onoff_brightness_colortemp_colorxy,
        ota: ota.zigbeeOTA,
    },
