...
const devices = [
    ...
    },
    {
        ...
        fromZigbee: [fz.command_recall, fz.command_move_hue, fz.command_move, fz.command_stop, fz.command_on, fz.command_off,
            fz.command_move_to_color_temp, fz.command_move_to_color, fz.battery],
        toZigbee: [],
        exposes: [e.battery(), e.action(['on', 'off', 'brightness_step_up', 'brightness_step_down', 'brightness_move_up',
    ...
    },
    {
        ...
        extend: [e.light_onoff_brightness_colortemp_colorxy().removeFeature('color_temp_startup'), e.effect()],
        meta: {applyRedFix: true},
    },
    {
        ...
        exposes: [e.light_brightness_colorhs().setAccess('brightness', ea.STATE_SET).removeFeature('color_temp_startup')],
    },
    {
    ...
    },
    {
        ...
        extend: [e.light_onoff_brightness_colortemp().removeFeature('color_temp_startup'), e.effect()],
    },
    {
