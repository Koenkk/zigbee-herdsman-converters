...
const devices = [
    ...
    },
    {
        ...
        fromZigbee: [
            fz.on_off_xiaomi_ignore_endpoint_4_5_6, fz.QBKG03LM_QBKG12LM_click, fz.legacy_QBKG03LM_QBKG12LM_click, fz.xiaomi_power_from_basic,
            fz.QBKG03LM_QBKG12LM_operation_mode, fz.QBKG12LM_click, fz.legacy_QBKG12LM_click, fz.xiaomi_power,
        ],
        meta: {multiEndpoint: true},
        toZigbee: [tz.on_off, tz.xiaomi_switch_operation_mode],
        endpoint: (device) => {
    ...
    },
    {
        ...
        fromZigbee: [fz.battery_not_divided, fz.cover_close, fz.legacy_cover_close, fz.cover_open, fz.legacy_cover_open, fz.cover_stop, fz.legacy_cover_stop],
        toZigbee: [],
        meta: {configureKey: 1},
        ota: ota.tradfri,
        configure: async (device, coordinatorEndpoint) => {
    ...
    },
    {
        ...
        fromZigbee: [
            fz.scenes_recall_click, fz.legacy_scenes_recall_click, fz.genOnOff_cmdOn, fz.legacy_genOnOff_cmdOn, fz.genOnOff_cmdOff, fz.legacy_genOnOff_cmdOff, fz.battery,
    ...
    // RGB genie
    {
        ...
        fromZigbee: [
            ...
            fz.ZGRC013_cmdOn, fz.legacy_ZGRC013_cmdOn, fz.ZGRC013_cmdOff, fz.legacy_ZGRC013_cmdOff, fz.ZGRC013_scene,
        ],
        toZigbee: [],
        meta: {configureKey: 1},
        configure: async (device, coordinatorEndpoint) => {
