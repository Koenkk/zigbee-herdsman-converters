...
const devices = [
    ...
    },
    {
        ...
        fromZigbee: [fz.battery, fz.command_on, fz.command_off, fz.command_step, fz.command_step_color_temperature, fz.ignore_genOta, fz.ignore_onoff_report, fz.ignore_genLevelCtrl_report],
