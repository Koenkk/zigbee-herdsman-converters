...
const hue = {
    light_onoff_brightness: {
        ...
        fromZigbee: [fz.light_brightness, fz.light_state],
        toZigbee: [
            tz.on_off, tz.light_brightness, tz.ignore_transition, tz.light_alert, tz.hue_power_on_behavior,
            tz.hue_power_on_brightness, tz.hue_power_on_color_temperature,
        ],
    },
    light_onoff_brightness_colortemp: {
        ...
        fromZigbee: [fz.light_brightness, fz.light_color_colortemp, fz.light_state],
        toZigbee: [
            tz.on_off, tz.light_brightness, tz.light_colortemp, tz.ignore_transition, tz.light_alert,
            tz.hue_power_on_behavior, tz.hue_power_on_brightness, tz.hue_power_on_color_temperature,
        ],
    },
    light_onoff_brightness_colorxy: {
        ...
        fromZigbee: [fz.light_brightness, fz.light_color_colortemp, fz.light_state],
        toZigbee: [
            tz.on_off, tz.light_brightness, tz.light_color, tz.ignore_transition, tz.light_alert,
            tz.hue_power_on_behavior, tz.hue_power_on_brightness, tz.hue_power_on_color_temperature,
        ],
    },
    light_onoff_brightness_colortemp_colorxy: {
        ...
        toZigbee: [
            tz.on_off, tz.light_brightness, tz.light_colortemp, tz.light_color, tz.ignore_transition,
            tz.light_alert, tz.hue_power_on_behavior, tz.hue_power_on_brightness, tz.hue_power_on_color_temperature,
        ],
    },
};
...
const devices = [
    ...
    // Philips
    {
        ...
        supports: hue.light_onoff_brightness_colorxy.supports,
        fromZigbee: hue.light_onoff_brightness_colorxy.fromZigbee,
        toZigbee: hue.light_onoff_brightness_colorxy.toZigbee,
    },
    {
        zigbeeModel: ['LLC020'],
        model: '7146060PH',
        vendor: 'Philips',
        description: 'Hue Go',
        supports: hue.light_onoff_brightness_colortemp_colorxy.supports,
        fromZigbee: hue.light_onoff_brightness_colortemp_colorxy.fromZigbee,
        toZigbee: hue.light_onoff_brightness_colortemp_colorxy.toZigbee,
    },
    {
        zigbeeModel: ['LWB004'],
        model: '433714',
        ...
        fromZigbee: hue.light_onoff_brightness.fromZigbee,
        toZigbee: hue.light_onoff_brightness.toZigbee,
    },
    {
    ...
    },
    {
        ...
        supports: hue.light_onoff_brightness_colortemp.supports,
        fromZigbee: hue.light_onoff_brightness_colortemp.fromZigbee,
        toZigbee: hue.light_onoff_brightness_colortemp.toZigbee,
    },
    {
        zigbeeModel: ['LTW012'],
        model: '8718696695203',
