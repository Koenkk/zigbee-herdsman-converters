...
module.exports = [
    ...
    },
    {
        ...
        exposes: [e.light_brightness(),
            ...
            exposes.numeric('ballast_physical_minimum_level', ea.STATE_GET).withValueMin(1).withValueMax(254)
                .withDescription('Specifies the minimum light output the ballast can achieve.'),
            exposes.numeric('ballast_physical_maximum_level', ea.STATE_GET).withValueMin(1).withValueMax(254)
