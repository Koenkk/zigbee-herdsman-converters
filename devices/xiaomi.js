...
module.exports = [
    ...
    },
    {
        ...
        meta: {battery: {voltageToPercentage: '3V_2100'}},
        exposes: [e.battery(), e.action(['single_left', 'single_right', 'single_both', 'double_left', 'double_right',
            'hold_left', 'hold_right']), e.battery_voltage(),
            exposes.enum('click_mode', ea.SET, ['fast', 'multi']).withDescription('Click mode'),
        ],
