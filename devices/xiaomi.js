...
module.exports = [
    {
        ...
        fromZigbee: [fz.ias_contact_alarm_1, fz.aqara_opple, fz.xiaomi_basic],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fz. xiaomi_contact, fz.ias_contact_alarm_1, fz.aqara_opple,fz.xiaomi_basic],
        toZigbee: [],
        meta: {battery: {voltageToPercentage: '3V_2850_3000_log'}},
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_opple, fz.temperature, fz.humidity, fz.pressure, fz.xiaomi_basic],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_occupancy_illuminance, fz.aqara_opple, fz.xiaomi_basic],
    ...
    },
    {
        ...
        fromZigbee: [fz.RTCGQ13LM_occupancy, fz.aqara_opple, fz.xiaomi_basic],
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_opple, fz.xiaomi_basic],
    ...
    },
    {
        ...
        fromZigbee: [fz.xiaomi_basic, fz.xiaomi_curtain_position_tilt, fz.aqara_opple, fz.power_source],
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_opple_on, fz.aqara_opple_off, fz.xiaomi_basic, fz.aqara_opple_multistate, fz.aqara_opple],
        exposes: [e.battery(), e.battery_voltage(), e.action([
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_opple_on, fz.aqara_opple_off, fz.aqara_opple_step, fz.aqara_opple_step_color_temp, fz.xiaomi_basic,
    ...
    },
    {
        ...
        fromZigbee: [fz.aqara_opple_on, fz.aqara_opple_off, fz.aqara_opple_step, fz.aqara_opple_move, fz.aqara_opple_stop,
            fz.aqara_opple_step_color_temp, fz.aqara_opple_move_color_temp, fz.xiaomi_basic, fz.aqara_opple_multistate, fz.aqara_opple],
        exposes: [e.battery(), e.battery_voltage(), e.action([
            'button_1_hold', 'button_1_release', 'button_1_single', 'button_1_double', 'button_1_triple',
            'button_2_hold', 'button_2_release', 'button_2_single', 'button_2_double', 'button_2_triple',
            'button_3_hold', 'button_3_release', 'button_3_single', 'button_3_double', 'button_3_triple',
    ...
    },
    {
        ...
        fromZigbee: [fz.xiaomi_basic, fz.illuminance, fz.aqara_opple],
        toZigbee: [],
        meta: {battery: {voltageToPercentage: '3V_2850_3000_log'}},
        configure: async (device, coordinatorEndpoint, logger) => {
            const endpoint = device.getEndpoint(1);
    ...
    },
    {
        ...
        fromZigbee: [fz.xiaomi_basic, fz.xiaomi_multistate_action, fz.aqara_opple, fz.command_toggle],
    ...
    },
    {
        ...
        fromZigbee: [fz.xiaomi_tvoc, fz.xiaomi_basic, fz.temperature, fz.humidity, fz.aqara_opple],
        toZigbee: [],
        meta: {battery: {voltageToPercentage: '3V_2850_3000_log'}},
