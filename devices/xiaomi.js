...
module.exports = [
  ...
  },
  {
    ...
    fromZigbee: extend
      ...
      .fromZigbee.concat([fz.xiaomi_power, fz.aqara_opple]),
    toZigbee: extend
      .light_onoff_brightness_colortemp_color()
      .toZigbee.concat([
        tz.xiaomi_dimmer_mode,
    ...
    exposes: [
      ...
      e
        ...
        .withEndpoint("l2"),
      exposes
        .enum("dimmer_mode", ea.ALL, ["rgbw", "dual_ct"])
        .withDescription(
  ...
  },
  {
    ...
    toZigbee: xiaomiExtend
      .light_onoff_brightness_colortemp({ colorTempRange: [153, 370] })
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .enum("operation_mode", ea.STATE_SET, ["control_relay", "decoupled"])
        .withDescription("Decoupled mode"),
    ],
    toZigbee: [
      tz.on_off,
      { ...tz.xiaomi_switch_operation_mode_basic, convertGet: null },
    ],
    endpoint: (device) => {
  ...
  },
  {
    ...
    toZigbee: [
      tz.on_off,
      tz.xiaomi_switch_operation_mode_basic,
      tz.xiaomi_power,
    ],
    endpoint: (device) => {
      return { system: 1 };
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .enum("operation_mode", ea.STATE_SET, [
          "control_left_relay",
          "control_right_relay",
          "decoupled",
        ])
  ...
  },
  {
    ...
    fromZigbee: [fz.aqara_occupancy_illuminance, fz.aqara_opple, fz.battery],
    toZigbee: [
      tz.aqara_detection_interval,
      tz.aqara_motion_sensitivity,
      tz.RTCGQ14LM_trigger_indicator,
    ],
    exposes: [
      e.occupancy(),
      e.illuminance_lux().withProperty("illuminance"),
      ...
      exposes
        .binary("trigger_indicator", ea.ALL, true, false)
        .withDescription(
  ...
  },
  {
    ...
    toZigbee: [
      tz.RTCZCGQ11LM_presence,
      tz.RTCZCGQ11LM_monitoring_mode,
      tz.RTCZCGQ11LM_approach_distance,
      tz.aqara_motion_sensitivity,
      tz.RTCZCGQ11LM_reset_nopresence_status,
    ],
    exposes: [
      e.presence().withAccess(ea.STATE_GET),
      exposes
        .enum("presence_event", ea.STATE, [
          "enter",
          "leave",
          "left_enter",
          "right_leave",
      ...
      exposes
        .enum("reset_nopresence_status", ea.SET, [""])
        .withDescription("Reset the status of no presence"),
      e.device_temperature(),
      e.power_outage_count(),
    ],
    configure: async (device, coordinatorEndpoint, logger) => {
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      try {
        ...
        logger.warn(
          `SP-EUC01 failed to setup electricity measurements (${e.message})`
        );
    ...
    onEvent: async (type, data, device) => {
      ...
      if (type === "stop") {
        ...
        const interval = setInterval(async () => {
          try {
            await switchEndpoint.read("genDeviceTempCfg", [
              "currentTemperature",
            ]);
          } catch (error) {
            // Do nothing
    ...
    exposes: [
      ...
      e
        .device_temperature()
        .withDescription("Device temperature (polled every 30 min)"),
    ],
    ota: ota.zigbeeOTA,
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary("auto_off", ea.STATE_SET, true, false)
        .withDescription(
          "If the power is constantly lower than 2W within half an hour, " +
    ...
    onEvent: async (type, data, device) => {
      ...
      if (
        ...
        device
          .getEndpoint(1)
          .readResponse("genTime", data.meta.zclTransactionSequenceNumber, {
            time: secondsLocal,
          });
      }
    },
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes.numeric("smoke_density", ea.STATE),
      exposes.enum("selftest", ea.SET, [""]),
      e.battery_voltage(),
      exposes
        .binary("test", ea.STATE, true, false)
        .withDescription("Test mode activated"),
      e.device_temperature(),
      e.power_outage_count(false),
    ],
  },
  {
    ...
    exposes: [
      ...
      e.tamper(),
      exposes.enum("sensitivity", ea.STATE_SET, ["low", "medium", "high"]),
      exposes.numeric("gas_density", ea.STATE),
      exposes.enum("selftest", ea.SET, [""]),
    ],
  },
  {
    ...
    toZigbee: [
      tz.aqara_alarm,
      tz.aqara_density,
      tz.JTBZ01AQA_gas_sensitivity,
      tz.aqara_selftest,
      tz.aqara_buzzer,
      tz.aqara_buzzer_manual,
      tz.aqara_linkage_alarm,
      tz.JTBZ01AQA_state,
      tz.aqara_power_outage_count,
    ],
    exposes: [
      e.gas().withAccess(ea.STATE_GET),
      exposes
        .numeric("gas_density", ea.STATE_GET)
        .withUnit("%LEL")
        .withDescription("Value of gas concentration"),
      exposes
        .enum("gas_sensitivity", ea.ALL, ["10%LEL", "15%LEL"])
        .withDescription(
          "Gas concentration value at which " +
            'an alarm is triggered ("10%LEL" is more sensitive than "15%LEL")'
        ),
      exposes
        .enum("selftest", ea.SET, ["selftest"])
        .withDescription(
          "Starts the self-test process (checking the indicator " +
            "light and buzzer work properly)"
        ),
      exposes
        .binary("test", ea.STATE, true, false)
        .withDescription("Self-test in progress"),
      exposes
      ...
      exposes
        .binary("buzzer_manual_alarm", ea.STATE_GET, true, false)
        .withDescription("Buzzer alarmed (manually)"),
      exposes
        .binary("buzzer_manual_mute", ea.STATE_GET, true, false)
        .withDescription("Buzzer muted (manually)"),
      exposes
      ...
      exposes
        .binary("linkage_alarm_state", ea.STATE, true, false)
        .withDescription('"linkage_alarm" is triggered'),
      exposes
  ...
  },
  {
    ...
    toZigbee: [
      ...
      tz.aqara_buzzer,
      tz.aqara_buzzer_manual,
      tz.JYGZ01AQ_heartbeat_indicator,
      tz.aqara_linkage_alarm,
    ],
    exposes: [
      e.smoke().withAccess(ea.STATE_GET),
      exposes
        .numeric("smoke_density", ea.STATE_GET)
        .withDescription("Value of smoke concentration"),
      exposes
        .numeric("smoke_density_dbm", ea.STATE_GET)
        .withUnit("dB/m")
        .withDescription("Value of smoke concentration in dB/m"),
      exposes
        .enum("selftest", ea.SET, ["selftest"])
        .withDescription(
          "Starts the self-test process (checking the indicator " +
      ...
      exposes
        ...
        .withDescription(
          "When this option is enabled then in " +
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes.numeric("strength", ea.STATE),
      exposes.enum("sensitivity", ea.STATE_SET, ["low", "medium", "high"]),
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary("running", ea.STATE, true, false)
        .withDescription("Whether the motor is moving or not"),
      exposes
        .enum("motor_state", ea.STATE, ["stopped", "opening", "closing"])
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.xiaomi_curtain_position,
      fz.xiaomi_curtain_position_tilt,
      fz.xiaomi_curtain_hagl04_status,
    ],
    toZigbee: [tz.xiaomi_curtain_position_state, tz.xiaomi_curtain_options],
    onEvent: async (type, data, device) => {
    ...
    exposes: [
      ...
      exposes
        ...
        .withDescription("Whether the motor is moving or not"),
      exposes
        .enum("motor_state", ea.STATE, ["closing", "opening", "stop"])
  ...
  },
  {
    ...
    fromZigbee: [
      fz.xiaomi_curtain_position,
      fz.xiaomi_curtain_acn002_status,
      fz.ignore_basic_report,
      fz.aqara_opple,
    ],
    toZigbee: [
      tz.xiaomi_curtain_position_state,
      tz.xiaomi_curtain_acn002_battery,
      tz.xiaomi_curtain_acn002_charging_status,
    ],
    onEvent: async (type, data, device) => {
      if (
        type === "message" &&
    ...
    exposes: [
      ...
      e.device_temperature(),
      exposes
        .binary("charging_status", ea.STATE_GET, true, false)
        .withDescription("The current charging status."),
      exposes
        .enum("motor_state", ea.STATE, [
          "declining",
          "rising",
          "pause",
          "blocked",
  ...
  },
  {
    ...
    exposes: [
      ...
      exposes
        .numeric("target_position", ea.STATE)
        .withUnit("%")
        .withDescription("Target position"),
      exposes
        .enum("power_source", ea.STATE_GET, ["battery", "dc_source"])
        .withDescription("The current power source"),
      exposes
        .binary("charging", ea.STATE_GET, true, false)
        .withDescription("The current charging state"),
    ],
    configure: async (device, coordinatorEndpoint, logger) => {
      const endpoint = device.getEndpoint(1);
  ...
  },
  {
    ...
    exposes: [
      ...
      e.power_outage_memory(),
      exposes
        .binary("interlock", ea.STATE_SET, true, false)
        .withDescription(
  ...
  },
  {
    ...
    exposes: [
      ...
      e.switch().withEndpoint("right"),
      exposes
        .binary("standby_enabled", ea.STATE_SET, true, false)
        .withDescription("Enable standby"),
      exposes
        .enum("theme", ea.STATE_SET, ["classic", "concise"])
        .withDescription("Display theme"),
      exposes
        .enum("beep_volume", ea.STATE_SET, ["mute", "low", "medium", "high"])
      ...
      exposes
        .enum("language", ea.STATE_SET, ["chinese", "english"])
        .withDescription("Interface language"),
      exposes
        .enum("screen_saver_style", ea.STATE_SET, ["classic", "analog clock"])
        .withDescription("Screen saver style"),
      exposes
        .numeric("standby_time", ea.STATE_SET)
        .withValueMin(0)
        .withValueMax(65534)
        .withUnit("s")
        .withDescription("Display standby time"),
      exposes
        .enum("font_size", ea.STATE_SET, ["small", "medium", "large"])
        .withDescription("Display font size"),
      exposes
        .binary("lcd_auto_brightness_enabled", ea.STATE_SET, true, false)
        .withDescription("Enable LCD auto brightness"),
      exposes
        .enum("homepage", ea.STATE_SET, [
          "scene",
          "feel",
          "thermostat",
          "switch",
      ...
      exposes
        .binary("screen_saver_enabled", ea.STATE_SET, true, false)
      ...
      exposes
        .enum("available_switches", ea.STATE_SET, [
          "none",
          "1",
          "2",
          "3",
      ...
      exposes
        .composite("switch_1_text_icon", "switch_1_text_icon")
        .withDescription("Switch 1 text and icon")
        .withFeature(
          exposes
            .enum("switch_1_icon", ea.STATE_SET, [
              "1",
              "2",
              "3",
              "4",
        ...
        .withFeature(
          exposes.text("switch_1_text", ea.STATE_SET).withDescription("Text")
        ),
      exposes
        .composite("switch_2_text_icon", "switch_2_text_icon")
        .withDescription("Switch 2 text and icon")
        .withFeature(
          exposes
            .enum("switch_2_icon", ea.STATE_SET, [
              "1",
              "2",
              "3",
              "4",
        ...
        .withFeature(
          exposes.text("switch_2_text", ea.STATE_SET).withDescription("Text")
        ),
      exposes
        .composite("switch_3_text_icon", "switch_3_text_icon")
        .withDescription("Switch 3 text and icon")
        .withFeature(
          exposes
            .enum("switch_3_icon", ea.STATE_SET, [
              "1",
              "2",
              "3",
              "4",
        ...
        .withFeature(
          exposes.text("switch_3_text", ea.STATE_SET).withDescription("Text")
        ),
    ],
    configure: async (device, coordinatorEndpoint, logger) => {
  ...
  },
  {
    ...
    exposes: [
      ...
      e.button_lock(),
      exposes
        .enum("button_switch_mode", exposes.access.ALL, [
          "relay",
          "relay_and_usb",
        ])
        .withDescription(
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint, logger) => {
      ...
      await endpoint1.read("aqaraOpple", [0x0125], {
        manufacturerCode: 0x115f,
      });
    },
  },
  {
    ...
    exposes: [
      ...
      exposes
        .binary("calibrated", ea.STATE, true, false)
  ...
  },
  {
    ...
    exposes: [
      exposes
        .enum("feed", ea.STATE_SET, ["START"])
        .withDescription("Start feeding"),
      exposes
        .enum("feeding_source", ea.STATE, ["schedule", "manual", "remote"])
        .withDescription("Feeding source"),
      exposes
        .numeric("feeding_size", ea.STATE)
        .withDescription("Feeding size")
        .withUnit("portion"),
      exposes
        .numeric("portions_per_day", ea.STATE)
        .withDescription("Portions per day"),
      exposes
        .numeric("weight_per_day", ea.STATE)
        .withDescription("Weight per day")
        .withUnit("g"),
      exposes
        .binary("error", ea.STATE, true, false)
      ...
      exposes
        .list(
          ...
          exposes
            ...
            .withFeature(
              exposes.enum("days", exposes.access.STATE_SET, [
                "everyday",
                "workdays",
                "weekend",
                "mon",
      ...
      e.child_lock(),
      exposes
        .enum("mode", ea.STATE_SET, ["schedule", "manual"])
        .withDescription("Feeding mode"),
      exposes
