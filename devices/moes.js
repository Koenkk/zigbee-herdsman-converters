...
module.exports = [
    ...
    },
    {
        ...
        exposes: [e.child_lock(), e.deadzone_temperature(), e.max_temperature_limit(), e.min_temperature_limit(),
            ...
            exposes.numeric('weekdays_p1_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('weekdays_p1_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('weekdays_p1_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('weekdays_p2_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('weekdays_p2_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('weekdays_p2_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('weekdays_p3_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('weekdays_p3_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('weekdays_p3_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('weekdays_p4_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('weekdays_p4_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('weekdays_p4_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('saturday_p1_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('saturday_p1_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('saturday_p1_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('saturday_p2_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('saturday_p2_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('saturday_p2_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('saturday_p3_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('saturday_p3_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('saturday_p3_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('saturday_p4_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('saturday_p4_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('saturday_p4_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('sunday_p1_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('sunday_p1_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('sunday_p1_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('sunday_p2_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('sunday_p2_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('sunday_p2_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
            exposes.numeric('sunday_p3_hour', ea.STATE_SET).withUnit('h').withValueMin(0).withValueMax(23),
            exposes.numeric('sunday_p3_minute', ea.STATE_SET).withUnit('m').withValueMin(0).withValueMax(59),
            exposes.numeric('sunday_p3_temperature', ea.STATE_SET).withUnit('°C').withValueMin(5).withValueMax(35).withValueStep(0.5),
