...
module.exports = [
    ...
    },
    {
        ...
        exposes: [
            ...
            e.schedule().withDescription('There are 8 periods in the schedule in total. ' +
            ...
            exposes.binary('factory_reset', ea.STATE_SET, 'ON', 'OFF')
                .withDescription('Resets all settings to default. Doesn\'t unpair device. Wait approximately one minute after turning ' +
                'it on. It will not go back to the "OFF" state by itself, so you can manually toggle it back.'),
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [104, 'brightness_state', tuya.valueConverter.lookupIgnoreError(
                    {'off': tuya.enum(0), 'low': tuya.enum(1), 'medium': tuya.enum(2), 'high': tuya.enum(3)})],
            ],
        },
        // need to be tested
        onEvent: tuya.onEventSetX5HTime,
    },
    {
