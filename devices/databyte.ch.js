...
module.exports = [
    {
        ...
        model: 'DTB190502A1',
        vendor: 'databyte.ch',
        description: '[CC2530 based IO Board](https://databyte.ch/project/zigbee-erstes-board-dtb190502a)',
    ...
    },
    {
        ...
        model: 'ED2004-012',
        vendor: 'databyte.ch',
        description: 'Panda 1 - wall switch (https://databyte.ch/project/zigbee-wallswitch-diy-ed2004-012-panda-1)',
    ...
    },
    {
        ...
        model: 'Touch4',
        vendor: 'databyte.ch',
        description: 'Wall Touchsensor with 4 keys (https://databyte.ch/project/zigbee-touch-key)',
