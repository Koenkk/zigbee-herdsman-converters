...
module.exports = [
    {
        ...
        toZigbee: [tz.thermostat_local_temperature, tz.thermostat_occupied_heating_setpoint, tz.thermostat_unoccupied_heating_setpoint,
            ...
            tz.sinope_thermostat_outdoor_temperature, tz.thermostat_min_heat_setpoint_limit, tz.thermostat_pi_heating_demand,
            ...
            tz.sinope_thermostat_occupancy, tz.electrical_measurement_power, tz.currentsummdelivered, tz.acvoltage, tz.accurrent],
        exposes: [
            exposes.climate()
