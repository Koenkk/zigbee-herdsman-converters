...
module.exports = [
    ...
    },
    {
        ...
        fromZigbee: [fz.command_move_to_color_temp, fz.command_step,
            fz.command_recall, fz.command_on, fz.command_off,
        ],
        exposes: [e.action([
            'color_temperature_move', 'brightness_step_up', 'brightness_step_down',
            'recall_*', 'on', 'off'])],
        toZigbee: [],
        meta: {multiEndpoint: true},
        endpoint: (device) => {
